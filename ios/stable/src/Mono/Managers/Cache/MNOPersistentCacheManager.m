//
//  PersistentCacheManager.m
//  Mono2
//

#import "MNOPersistentCacheManager.h"
...
@interface MNOPersistentCacheManager()

@property (readwrite, nonatomic) unsigned long index;

@end

@implementation MNOPersistentCacheManager

+(MNOPersistentCacheManager *) sharedManager
{
    static MNOPersistentCacheManager * sharedManager = nil;
