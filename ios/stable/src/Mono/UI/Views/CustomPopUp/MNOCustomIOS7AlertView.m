...
#import "MNOCustomIOS7AlertView.h"
...
@implementation MNOCustomIOS7AlertView
...
- (void)customIOS7dialogButtonTouchUpInside: (MNOCustomIOS7AlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex
{
    [self close];
}
