...
public class SSLUtils {
     ...
     * Apache HTTP stack.
     */
    public static SSLSocketFactory getHttpSocketFactory(boolean insecure, KeyManager keyManager) throws UnrecoverableKeyException, NoSuchAlgorithmException, KeyStoreException, KeyManagementException {
