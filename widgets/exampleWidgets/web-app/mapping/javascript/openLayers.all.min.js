var OpenLayers={VERSION_NUMBER:"Release 2.12",singleFile:!0,_getScriptLocation:function(){for(var a=/(^|(.*?\/))(OpenLayers[^\/]*?\.js)(\?|$)/,b=document.getElementsByTagName("script"),c,d="",e=0,f=b.length;e<f;e++)if(c=b[e].getAttribute("src"))if(c=c.match(a)){d=c[1];break}return function(){return d}}(),ImgPath:"",Class:function(){var a=arguments.length,b=arguments[0],c=arguments[a-1],d="function"==typeof c.initialize?c.initialize:function(){b.prototype.initialize.apply(this,arguments)};1<a?(a=[d,
b].concat(Array.prototype.slice.call(arguments).slice(1,a-1),c),OpenLayers.inherit.apply(null,a)):d.prototype=c;return d},inherit:function(a,b){var c=function(){};c.prototype=b.prototype;a.prototype=new c;var d,e,c=2;for(d=arguments.length;c<d;c++)e=arguments[c],"function"===typeof e&&(e=e.prototype),OpenLayers.Util.extend(a.prototype,e)}};OpenLayers.Util=OpenLayers.Util||{};
...
a.y,b)},contains:function(a,b,c){null==c&&(c=!0);if(null==a||null==b)return!1;a=OpenLayers.Util.toFloat(a);b=OpenLayers.Util.toFloat(b);return c?a>=this.left&&a<=this.right&&b>=this.bottom&&b<=this.top:a>this.left&&a<this.right&&b>this.bottom&&b<this.top},intersectsBounds:function(a,b){"boolean"===typeof b&&(b={inclusive:b});b=b||{};if(b.worldBounds){var c=this.wrapDateLine(b.worldBounds);a=a.wrapDateLine(b.worldBounds)}else c=this;null==b.inclusive&&(b.inclusive=!0);var d=!1,e=c.left==a.right||c.right==
a.left||c.top==a.bottom||c.bottom==a.top;if(b.inclusive||!e)var d=a.top>=c.bottom&&a.top<=c.top||c.top>a.bottom&&c.top<a.top,e=a.left>=c.left&&a.left<=c.right||c.left>=a.left&&c.left<=a.right,f=a.right>=c.left&&a.right<=c.right||c.right>=a.left&&c.right<=a.right,d=(a.bottom>=c.bottom&&a.bottom<=c.top||c.bottom>=a.bottom&&c.bottom<=a.top||d)&&(e||f);if(b.worldBounds&&!d){var g=b.worldBounds,e=g.getWidth(),f=!g.containsBounds(c),g=!g.containsBounds(a);f&&!g?(a=a.add(-e,0),d=c.intersectsBounds(a,{inclusive:b.inclusive})):
g&&!f&&(c=c.add(-e,0),d=a.intersectsBounds(c,{inclusive:b.inclusive}))}return d},containsBounds:function(a,b,c){null==b&&(b=!1);null==c&&(c=!0);var d=this.contains(a.left,a.bottom,c),e=this.contains(a.right,a.bottom,c),f=this.contains(a.left,a.top,c);a=this.contains(a.right,a.top,c);return b?d||e||f||a:d&&e&&f&&a},determineQuadrant:function(a){var b="",c=this.getCenterLonLat(),b=b+(a.lat<c.lat?"b":"t");return b+(a.lon<c.lon?"l":"r")},transform:function(a,b){this.centerLonLat=null;var c=OpenLayers.Projection.transform({x:this.left,
y:this.bottom},a,b),d=OpenLayers.Projection.transform({x:this.right,y:this.bottom},a,b),e=OpenLayers.Projection.transform({x:this.left,y:this.top},a,b),f=OpenLayers.Projection.transform({x:this.right,y:this.top},a,b);this.left=Math.min(c.x,e.x);this.bottom=Math.min(c.y,d.y);this.right=Math.max(d.x,f.x);this.top=Math.max(e.y,f.y);return this},wrapDateLine:function(a,b){b=b||{};var c=b.leftTolerance||0,d=b.rightTolerance||0,e=this.clone();if(a){for(var f=a.getWidth();e.left<a.left&&e.right-d<=a.left;)e=
e.add(f,0);for(;e.left+c>=a.right&&e.right>a.right;)e=e.add(-f,0);c=e.left+c;c<a.right&&c>a.left&&e.right-d>a.right&&(e=e.add(-f,0))}return e},CLASS_NAME:"OpenLayers.Bounds"});OpenLayers.Bounds.fromString=function(a,b){var c=a.split(",");return OpenLayers.Bounds.fromArray(c,b)};OpenLayers.Bounds.fromArray=function(a,b){return!0===b?new OpenLayers.Bounds(a[1],a[0],a[3],a[2]):new OpenLayers.Bounds(a[0],a[1],a[2],a[3])};OpenLayers.Bounds.fromSize=function(a){return new OpenLayers.Bounds(0,a.h,a.w,0)};
OpenLayers.Bounds.oppositeQuadrant=function(a){return""+("t"==a.charAt(0)?"b":"t")+("l"==a.charAt(1)?"r":"l")};
...
OpenLayers.Util.distVincenty=function(a,b){for(var c=OpenLayers.Util.VincentyConstants,d=c.a,e=c.b,c=c.f,f=OpenLayers.Util.rad(b.lon-a.lon),g=Math.atan((1-c)*Math.tan(OpenLayers.Util.rad(a.lat))),h=Math.atan((1-c)*Math.tan(OpenLayers.Util.rad(b.lat))),k=Math.sin(g),g=Math.cos(g),l=Math.sin(h),h=Math.cos(h),m=f,p=2*Math.PI,n=20;1E-12<Math.abs(m-p)&&0<--n;){var q=Math.sin(m),r=Math.cos(m),v=Math.sqrt(h*q*h*q+(g*l-k*h*r)*(g*l-k*h*r));if(0==v)return 0;var r=k*l+g*h*r,w=Math.atan2(v,r),x=Math.asin(g*h*
q/v),D=Math.cos(x)*Math.cos(x),q=r-2*k*l/D,C=c/16*D*(4+c*(4-3*D)),p=m,m=f+(1-C)*c*Math.sin(x)*(w+C*v*(q+C*r*(-1+2*q*q)))}if(0==n)return NaN;d=D*(d*d-e*e)/(e*e);c=d/1024*(256+d*(-128+d*(74-47*d)));return(e*(1+d/16384*(4096+d*(-768+d*(320-175*d))))*(w-c*v*(q+c/4*(r*(-1+2*q*q)-c/6*q*(-3+4*v*v)*(-3+4*q*q))))).toFixed(3)/1E3};
OpenLayers.Util.destinationVincenty=function(a,b,c){var d=OpenLayers.Util,e=d.VincentyConstants,f=e.a,g=e.b,h=e.f,e=a.lon;a=a.lat;var k=d.rad(b);b=Math.sin(k);k=Math.cos(k);a=(1-h)*Math.tan(d.rad(a));var l=1/Math.sqrt(1+a*a),m=a*l,p=Math.atan2(a,k);a=l*b;for(var n=1-a*a,f=n*(f*f-g*g)/(g*g),q=1+f/16384*(4096+f*(-768+f*(320-175*f))),r=f/1024*(256+f*(-128+f*(74-47*f))),f=c/(g*q),v=2*Math.PI;1E-12<Math.abs(f-v);)var w=Math.cos(2*p+f),x=Math.sin(f),D=Math.cos(f),C=r*x*(w+r/4*(D*(-1+2*w*w)-r/6*w*(-3+4*
x*x)*(-3+4*w*w))),v=f,f=c/(g*q)+C;c=m*x-l*D*k;g=Math.atan2(m*D+l*x*k,(1-h)*Math.sqrt(a*a+c*c));b=Math.atan2(x*b,l*D-m*x*k);k=h/16*n*(4+h*(4-3*n));w=b-(1-k)*h*a*(f+k*x*(w+k*D*(-1+2*w*w)));Math.atan2(a,-c);return new OpenLayers.LonLat(e+d.deg(w),d.deg(g))};
...
c.hash?"":c.hash;var e=c.search;e||(e=a.indexOf("?"),e=-1!=e?a.substr(e):"");d.args=OpenLayers.Util.getParameters(e);d.pathname="/"==c.pathname.charAt(0)?c.pathname:"/"+c.pathname;return d};OpenLayers.Util.removeTail=function(a){var b=null,b=a.indexOf("?"),c=a.indexOf("#");return-1==b?-1!=c?a.substr(0,c):a:-1!=c?a.substr(0,Math.min(b,c)):a.substr(0,b)};OpenLayers.IS_GECKO=function(){var a=navigator.userAgent.toLowerCase();return-1==a.indexOf("webkit")&&-1!=a.indexOf("gecko")}();
...
OpenLayers.Util.getScrollbarWidth=function(){var a=OpenLayers.Util._scrollbarWidth;if(null==a){var b=null,c=null,b=document.createElement("div");b.style.position="absolute";b.style.top="-1000px";b.style.left="-1000px";b.style.width="100px";b.style.height="50px";b.style.overflow="hidden";c=document.createElement("div");c.style.width="100%";c.style.height="200px";b.appendChild(c);document.body.appendChild(b);a=c.offsetWidth;b.style.overflow="scroll";b=c.offsetWidth;document.body.removeChild(document.body.lastChild);
OpenLayers.Util._scrollbarWidth=a-b;a=OpenLayers.Util._scrollbarWidth}return a};
OpenLayers.Util.getFormattedLonLat=function(a,b,c){c||(c="dms");a=(a+540)%360-180;var d=Math.abs(a),e=Math.floor(d),f=d=(d-e)/(1/60),d=Math.floor(d),f=Math.round(10*((f-d)/(1/60))),f=f/10;60<=f&&(f-=60,d+=1,60<=d&&(d-=60,e+=1));10>e&&(e="0"+e);e+="\u00b0";0<=c.indexOf("dm")&&(10>d&&(d="0"+d),e+=d+"'",0<=c.indexOf("dms")&&(10>f&&(f="0"+f),e+=f+'"'));return"lon"==b?e+(0>a?OpenLayers.i18n("W"):OpenLayers.i18n("E")):e+(0>a?OpenLayers.i18n("S"):OpenLayers.i18n("N"))};
...
this.element.scrolls[0]-this.element.offsets[0]-this.element.lefttop[0],a.clientY+this.element.scrolls[1]-this.element.offsets[1]-this.element.lefttop[1])},CLASS_NAME:"OpenLayers.Events"});
...
Math.min(a.top+Math.abs(a.getHeight()),this.ovmap.size.h-this.hComp);a=Math.min(a.left+a.getWidth(),this.ovmap.size.w-this.wComp);var e=Math.max(a-c,0),f=Math.max(d-b,0);e<this.minRectSize||f<this.minRectSize?(this.extentRectangle.className=this.displayClass+this.minRectDisplayClass,e=c+e/2-this.minRectSize/2,this.extentRectangle.style.top=Math.round(b+f/2-this.minRectSize/2)+"px",this.extentRectangle.style.left=Math.round(e)+"px",this.extentRectangle.style.height=this.minRectSize+"px",this.extentRectangle.style.width=
...
(function(){function a(a){a.x=180*a.x/d;a.y=180/Math.PI*(2*Math.atan(Math.exp(a.y/d*Math.PI))-Math.PI/2);return a}function b(a){a.x=a.x*d/180;a.y=Math.log(Math.tan((90+a.y)*Math.PI/360))/Math.PI*d;return a}function c(c,d){var e=OpenLayers.Projection.addTransform,f=OpenLayers.Projection.nullTransform,g,n,q,r,v;g=0;for(n=d.length;g<n;++g)for(q=d[g],e(c,q,b),e(q,c,a),v=g+1;v<n;++v)r=d[v],e(q,r,f),e(r,q,f)}var d=2.003750834E7,e=["EPSG:900913","EPSG:3857","EPSG:102113","EPSG:102100"],f=["CRS:84","urn:ogc:def:crs:EPSG:6.6:4326",
...
!this.restrictedExtent||this.restrictedExtent instanceof OpenLayers.Bounds||(this.restrictedExtent=new OpenLayers.Bounds(this.restrictedExtent));!this.center||this.center instanceof OpenLayers.LonLat||(this.center=new OpenLayers.LonLat(this.center));this.layers=[];this.id=OpenLayers.Util.createUniqueID("OpenLayers.Map_");(this.div=OpenLayers.Util.getElement(a))||(this.div=document.createElement("div"),this.div.style.height="1px",this.div.style.width="1px");OpenLayers.Element.addClass(this.div,"olMap");
var c=this.id+"_OpenLayers_ViewPort";this.viewPortDiv=OpenLayers.Util.createDiv(c,null,null,null,"relative",null,"hidden");this.viewPortDiv.style.width="100%";this.viewPortDiv.style.height="100%";this.viewPortDiv.className="olMapViewport";this.div.appendChild(this.viewPortDiv);this.events=new OpenLayers.Events(this,this.viewPortDiv,null,this.fallThrough,{includeXY:!0});c=this.id+"_OpenLayers_Container";this.layerContainerDiv=OpenLayers.Util.createDiv(c);this.layerContainerDiv.style.width="100px";
this.layerContainerDiv.style.height="100px";this.layerContainerDiv.style.zIndex=this.Z_INDEX_BASE.Popup-1;this.viewPortDiv.appendChild(this.layerContainerDiv);this.updateSize();if(this.eventListeners instanceof Object)this.events.on(this.eventListeners);9>parseFloat(navigator.appVersion.split("MSIE")[1])?this.events.register("resize",this,this.updateSize):(this.updateSizeDestroy=OpenLayers.Function.bind(this.updateSize,this),OpenLayers.Event.observe(window,"resize",this.updateSizeDestroy));if(this.theme){for(var c=
!0,d=document.getElementsByTagName("link"),e=0,f=d.length;e<f;++e)if(OpenLayers.Util.isEquivalentUrl(d.item(e).href,this.theme)){c=!1;break}c&&(c=document.createElement("link"),c.setAttribute("rel","stylesheet"),c.setAttribute("type","text/css"),c.setAttribute("href",this.theme),document.getElementsByTagName("head")[0].appendChild(c))}null==this.controls&&(this.controls=[],null!=OpenLayers.Control&&(OpenLayers.Control.Navigation?this.controls.push(new OpenLayers.Control.Navigation):OpenLayers.Control.TouchNavigation&&
this.controls.push(new OpenLayers.Control.TouchNavigation),OpenLayers.Control.Zoom?this.controls.push(new OpenLayers.Control.Zoom):OpenLayers.Control.PanZoom&&this.controls.push(new OpenLayers.Control.PanZoom),OpenLayers.Control.ArgParser&&this.controls.push(new OpenLayers.Control.ArgParser),OpenLayers.Control.Attribution&&this.controls.push(new OpenLayers.Control.Attribution)));e=0;for(f=this.controls.length;e<f;e++)this.addControlToMap(this.controls[e]);this.popups=[];this.unloadDestroy=OpenLayers.Function.bind(this.destroy,
...
if(a&&!isNaN(a.h)&&!isNaN(a.w)){this.events.clearMouseCache();var b=this.getSize();null==b&&(this.size=b=a);if(3<Math.abs(a.w-b.w)||3<Math.abs(a.h-b.h)){this.size=a;a=0;for(b=this.layers.length;a<b;a++)this.layers[a].onMapResize();a=this.getCachedCenter();null!=this.baseLayer&&null!=a&&(b=this.getZoom(),this.zoom=null,this.setCenter(a,b))}}},getCurrentSize:function(){var a=new OpenLayers.Size(this.div.clientWidth,this.div.clientHeight);if(0==a.w&&0==a.h||isNaN(a.w)&&isNaN(a.h))a.w=this.div.offsetWidth,
...
OpenLayers.Layer.SphericalMercator={getExtent:function(){return this.sphericalMercator?this.map.calculateBounds():OpenLayers.Layer.FixedZoomLevels.prototype.getExtent.apply(this)},getLonLatFromViewPortPx:function(a){return OpenLayers.Layer.prototype.getLonLatFromViewPortPx.apply(this,arguments)},getViewPortPxFromLonLat:function(a){return OpenLayers.Layer.prototype.getViewPortPxFromLonLat.apply(this,arguments)},initMercatorParameters:function(){this.RESOLUTIONS=[];for(var a=0;a<=this.MAX_ZOOM_LEVEL;++a)this.RESOLUTIONS[a]=
...
b)},createTextNode:function(a){"string"!==typeof a&&(a=""+a);return this.xmldom?this.xmldom.createTextNode(a):document.createTextNode(a)},getElementsByTagNameNS:function(a,b,c){var d=[];if(a.getElementsByTagNameNS)d=a.getElementsByTagNameNS(b,c);else{a=a.getElementsByTagName("*");for(var e,f,g=0,h=a.length;g<h;++g)if(e=a[g],f=e.prefix?e.prefix+":"+c:c,"*"==c||f==e.nodeName)"*"!=b&&b!=e.namespaceURI||d.push(e)}return d},getAttributeNodeNS:function(a,b,c){var d=null;if(a.getAttributeNodeNS)d=a.getAttributeNodeNS(b,
...
OpenLayers.Format.XML.document=null;OpenLayers.Format.WFST=function(a){a=OpenLayers.Util.applyDefaults(a,OpenLayers.Format.WFST.DEFAULTS);var b=OpenLayers.Format.WFST["v"+a.version.replace(/\./g,"_")];if(!b)throw"Unsupported WFST version: "+a.version;return new b(a)};OpenLayers.Format.WFST.DEFAULTS={version:"1.0.0"};
...
var e,f,g,h,k,l,m,p=0,n=d.length;a:for(;p<n;++p){c=d[p];e=c.x1;f=c.x2;g=c.y1;h=c.y2;for(var q=0,r=a.length;q<r;++q){k=a[q];if(k.x1>f)break;if(!(k.x2<e||(l=k.y1,m=k.y2,Math.min(l,m)>Math.max(g,h)||Math.max(l,m)<Math.min(g,h)||!OpenLayers.Geometry.segmentsIntersect(c,k)))){b=!0;break a}}}}else b=a.intersects(this);return b},getSortedSegments:function(){for(var a=this.components.length-1,b=Array(a),c,d,e=0;e<a;++e)c=this.components[e],d=this.components[e+1],b[e]=c.x<d.x?{x1:c.x,y1:c.y,x2:d.x,y2:d.y}:
{x1:d.x,y1:d.y,x2:c.x,y2:c.y};return b.sort(function(a,b){return a.x1-b.x1})},splitWithSegment:function(a,b){for(var c=!(b&&!1===b.edge),d=b&&b.tolerance,e=[],f=this.getVertices(),g=[],h=[],k=!1,l,m,p={point:!0,tolerance:d},n=null,q=0,r=f.length-2;q<=r;++q)if(d=f[q],g.push(d.clone()),l=f[q+1],m={x1:d.x,y1:d.y,x2:l.x,y2:l.y},m=OpenLayers.Geometry.segmentsIntersect(a,m,p),m instanceof OpenLayers.Geometry.Point&&((m.x===a.x1&&m.y===a.y1||m.x===a.x2&&m.y===a.y2||m.equals(d)||m.equals(l)?!0:!1)||c))m.equals(h[h.length-
1])||h.push(m.clone()),0===q&&m.equals(d)||m.equals(l)||(k=!0,m.equals(d)||g.push(m),e.push(new OpenLayers.Geometry.LineString(g)),g=[m.clone()]);k&&(g.push(l.clone()),e.push(new OpenLayers.Geometry.LineString(g)));if(0<h.length)var v=a.x1<a.x2?1:-1,w=a.y1<a.y2?1:-1,n={lines:e,points:h.sort(function(a,b){return v*a.x-v*b.x||w*a.y-w*b.y})};return n},split:function(a,b){var c=null,d=b&&b.mutual,e,f,g,h;if(a instanceof OpenLayers.Geometry.LineString){var k=this.getVertices(),l,m,p,n,q,r=[];g=[];for(var v=
0,w=k.length-2;v<=w;++v){l=k[v];m=k[v+1];p={x1:l.x,y1:l.y,x2:m.x,y2:m.y};h=h||[a];d&&r.push(l.clone());for(var x=0;x<h.length;++x)if(n=h[x].splitWithSegment(p,b))if(q=n.lines,0<q.length&&(q.unshift(x,1),Array.prototype.splice.apply(h,q),x+=q.length-2),d)for(var D=0,C=n.points.length;D<C;++D)q=n.points[D],q.equals(l)||(r.push(q),g.push(new OpenLayers.Geometry.LineString(r)),r=q.equals(m)?[]:[q.clone()])}d&&0<g.length&&0<r.length&&(r.push(m.clone()),g.push(new OpenLayers.Geometry.LineString(r)))}else c=
a.splitWith(this,b);h&&1<h.length?f=!0:h=[];g&&1<g.length?e=!0:g=[];if(f||e)c=d?[g,h]:h;return c},splitWith:function(a,b){return a.split(this,b)},getVertices:function(a){return!0===a?[this.components[0],this.components[this.components.length-1]]:!1===a?this.components.slice(1,this.components.length-1):this.components.slice()},distanceTo:function(a,b){var c=!(b&&!1===b.edge)&&b&&b.details,d,e={},f=Number.POSITIVE_INFINITY;if(a instanceof OpenLayers.Geometry.Point){for(var g=this.getSortedSegments(),
h=a.x,k=a.y,l,m=0,p=g.length;m<p;++m)if(l=g[m],d=OpenLayers.Geometry.distanceToSegment(a,l),d.distance<f){if(f=d.distance,e=d,0===f)break}else if(l.x2>h&&(k>l.y1&&k<l.y2||k<l.y1&&k>l.y2))break;e=c?{distance:e.distance,x0:e.x,y0:e.y,x1:h,y1:k}:e.distance}else if(a instanceof OpenLayers.Geometry.LineString){var g=this.getSortedSegments(),h=a.getSortedSegments(),n,q,r=h.length,v={point:!0},m=0,p=g.length;a:for(;m<p;++m){k=g[m];l=k.x1;q=k.y1;for(var w=0;w<r;++w)if(d=h[w],n=OpenLayers.Geometry.segmentsIntersect(k,
d,v)){f=0;e={distance:0,x0:n.x,y0:n.y,x1:n.x,y1:n.y};break a}else d=OpenLayers.Geometry.distanceToSegment({x:l,y:q},d),d.distance<f&&(f=d.distance,e={distance:f,x0:l,y0:q,x1:d.x,y1:d.y})}c||(e=e.distance);0!==f&&k&&(d=a.distanceTo(new OpenLayers.Geometry.Point(k.x2,k.y2),b),m=c?d.distance:d,m<f&&(e=c?{distance:f,x0:d.x1,y0:d.y1,x1:d.x0,y1:d.y0}:m))}else e=a.distanceTo(this,b),c&&(e={distance:e.distance,x0:e.x1,y0:e.y1,x1:e.x0,y1:e.y0});return e},simplify:function(a){if(this&&null!==this){var b=this.getVertices();
...
this.components[b+1],a=a+(d.x+e.x)*(e.y-d.y);a=-a/2}return a},getGeodesicArea:function(a){var b=this;if(a){var c=new OpenLayers.Projection("EPSG:4326");c.equals(a)||(b=this.clone().transform(a,c))}a=0;c=b.components&&b.components.length;if(2<c){for(var d,e,f=0;f<c-1;f++)d=b.components[f],e=b.components[f+1],a+=OpenLayers.Util.rad(e.x-d.x)*(2+Math.sin(OpenLayers.Util.rad(d.y))+Math.sin(OpenLayers.Util.rad(e.y)));a=40680631590769*a/2}return a},containsPoint:function(a){var b=OpenLayers.Number.limitSigDigs,
c=b(a.x,14);a=b(a.y,14);for(var d=this.components.length-1,e,f,g,h,k,l=0,m=0;m<d;++m)if(e=this.components[m],g=b(e.x,14),e=b(e.y,14),f=this.components[m+1],h=b(f.x,14),f=b(f.y,14),e==f){if(a==e&&(g<=h&&c>=g&&c<=h||g>=h&&c<=g&&c>=h)){l=-1;break}}else{k=b((a-f)*((h-g)/(f-e))+h,14);if(k==c&&(e<f&&a>=e&&a<=f||e>f&&a<=e&&a>=f)){l=-1;break}k<=c||g!=h&&(k<Math.min(g,h)||k>Math.max(g,h))||(e<f&&a>=e&&a<f||e>f&&a<e&&a>=f)&&++l}return-1==l?1:!!(l&1)},intersects:function(a){var b=!1;if("OpenLayers.Geometry.Point"==
...
OpenLayers.Bounds)c.push(a.left+","+a.bottom),c.push(a.right+","+a.top);else{a=a.components?a.components:[a];for(var d=0;d<a.length;d++)c.push(a[d].x+","+a[d].y)}c=this.createTextNode(c.join(" "));b.appendChild(c);return b},CLASS_NAME:"OpenLayers.Format.GML"});OpenLayers.Format.GML||(OpenLayers.Format.GML={});
...
"]");return c.join("")},string:function(a){var b={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"};return/["\\\x00-\x1f]/.test(a)?'"'+a.replace(/([\x00-\x1f\\"])/g,function(a,d){var e=b[d];if(e)return e;e=d.charCodeAt();return"\\u00"+Math.floor(e/16).toString(16)+(e%16).toString(16)})+'"':'"'+a+'"'},number:function(a){return isFinite(a)?""+a:"null"},"boolean":function(a){return""+a},date:function(a){function b(a){return 10>a?"0"+a:a}return'"'+a.getFullYear()+"-"+b(a.getMonth()+
1)+"-"+b(a.getDate())+"T"+b(a.getHours())+":"+b(a.getMinutes())+":"+b(a.getSeconds())+'"'}},CLASS_NAME:"OpenLayers.Format.JSON"});
...
var b=this.map.getSize(),c=Math.ceil(b.h/this.tileSize.h)+Math.max(1,2*this.buffer),b=Math.ceil(b.w/this.tileSize.w)+Math.max(1,2*this.buffer),d=this.getTileOrigin(),e=this.getServerResolution(),d=this.calculateGridLayout(a,d,e),e=Math.round(d.tileoffsetx),f=Math.round(d.tileoffsety),g=d.tileoffsetlon,h=d.tileoffsetlat,k=d.tilelon,l=d.tilelat,m=e,p=g,n=0,q=parseInt(this.map.layerContainerDiv.style.left),r=parseInt(this.map.layerContainerDiv.style.top),d=[],v=this.map.getCenter();do{var w=this.grid[n++];
w||(w=[],this.grid.push(w));var g=p,e=m,x=0;do{var D=new OpenLayers.Bounds(g,h,g+k,h+l),C=e,C=C-q,K=f,K=K-r,K=new OpenLayers.Pixel(C,K);(C=w[x++])?C.moveTo(D,K,!1):(C=this.addTile(D,K),this.addTileMonitoringHooks(C),w.push(C));D=D.getCenterLonLat();d.push({tile:C,distance:Math.pow(D.lon-v.lon,2)+Math.pow(D.lat-v.lat,2)});g+=k;e+=this.tileSize.w}while(g<=a.right+k*this.buffer||x<b);h-=l;f+=this.tileSize.h}while(h>=a.bottom-l*this.buffer||n<c);this.removeExcessTiles(n,x);this.gridResolution=this.getServerResolution();
...
c*Math.floor((e.lat-b.bottom)/c);return new OpenLayers.Bounds(a,b,a+d,b+c)},CLASS_NAME:"OpenLayers.Layer.Grid"});
...
a&&(a=new OpenLayers.Layer.ArcIMS(this.name,this.url,this.getOptions()));return OpenLayers.Layer.Grid.prototype.clone.apply(this,[a])},CLASS_NAME:"OpenLayers.Layer.ArcIMS"});
...
1+"px"},CLASS_NAME:"OpenLayers.Control.PanZoomBar"});OpenLayers.Format.WFSCapabilities=OpenLayers.Class(OpenLayers.Format.XML.VersionedOGC,{defaultVersion:"1.1.0",errorProperty:"service",CLASS_NAME:"OpenLayers.Format.WFSCapabilities"});
...
this.options&&this.options.tileOptions)},clone:function(a){null==a&&(a=new OpenLayers.Layer.OSM(this.name,this.url,this.getOptions()));return OpenLayers.Layer.XYZ.prototype.clone.apply(this,[a])},CLASS_NAME:"OpenLayers.Layer.OSM"});
...
b,c){var d=new Image;b.graphicTitle&&(d.title=b.graphicTitle);var e=b.graphicWidth||b.graphicHeight,f=b.graphicHeight||b.graphicWidth,e=e?e:2*b.pointRadius,f=f?f:2*b.pointRadius,g=void 0!=b.graphicXOffset?b.graphicXOffset:-(0.5*e),h=void 0!=b.graphicYOffset?b.graphicYOffset:-(0.5*f),k=b.graphicOpacity||b.fillOpacity;d.onload=OpenLayers.Function.bind(function(){if(this.features[c]){var b=this.getLocalXY(a),m=b[0],b=b[1];if(!isNaN(m)&&!isNaN(b)){var m=m+g|0,b=b+h|0,p=this.canvas;p.globalAlpha=k;var n=
OpenLayers.Renderer.Canvas.drawImageScaleFactor||(OpenLayers.Renderer.Canvas.drawImageScaleFactor=/android 2.1/.test(navigator.userAgent.toLowerCase())?320/window.screen.width:1);p.drawImage(d,m*n,b*n,e*n,f*n);this.hitDetection&&(this.setHitContextStyle("fill",c),this.hitContext.fillRect(m,b,e,f))}}},this);d.src=b.externalGraphic},drawNamedSymbol:function(a,b,c){var d,e,f,g;f=Math.PI/180;var h=OpenLayers.Renderer.symbol[b.graphicName];if(!h)throw Error(b.graphicName+" is not a valid symbol name");
...
a?(this.canvas.globalAlpha=b.fillOpacity,this.canvas.fillStyle=b.fillColor):"stroke"===a?(this.canvas.globalAlpha=b.strokeOpacity,this.canvas.strokeStyle=b.strokeColor,this.canvas.lineWidth=b.strokeWidth):(this.canvas.globalAlpha=0,this.canvas.lineWidth=1)},featureIdToHex:function(a){a=Number(a.split("_").pop())+1;16777216<=a&&(this.hitOverflow=a-16777215,a=a%16777216+1);a="000000"+a.toString(16);var b=a.length;return"#"+a.substring(b-6,b)},setHitContextStyle:function(a,b,c,d){b=this.featureIdToHex(b);
...
e[g]=k;h.used=!0}h=f?new OpenLayers.Geometry.Polygon(new OpenLayers.Geometry.LinearRing(e)):new OpenLayers.Geometry.LineString(e);this.internalProjection&&this.externalProjection&&h.transform(this.externalProjection,this.internalProjection);e=new OpenLayers.Feature.Vector(h,c[d].tags);e.osm_id=parseInt(c[d].id);e.fid="way."+e.osm_id;a[d]=e}for(var l in b){h=b[l];if(!h.used||this.checkTags){if(this.checkTags){c=this.getTags(h.node,!0);if(h.used&&!c[1])continue;c=c[0]}else c=this.getTags(h.node);e=
new OpenLayers.Feature.Vector(new OpenLayers.Geometry.Point(h.lon,h.lat),c);this.internalProjection&&this.externalProjection&&e.geometry.transform(this.externalProjection,this.internalProjection);e.osm_id=parseInt(l);e.fid="node."+e.osm_id;a.push(e)}h.node=null}return a},getNodes:function(a){a=a.getElementsByTagName("node");for(var b={},c=0;c<a.length;c++){var d=a[c],e=d.getAttribute("id");b[e]={lat:d.getAttribute("lat"),lon:d.getAttribute("lon"),node:d}}return b},getWays:function(a){a=a.getElementsByTagName("way");
...
c.CLASS_NAME)e=new OpenLayers.Feature.Vector(c,null,b.virtualStyle),e._sketch=!0,e.renderIntent=b.vertexRenderIntent,b.vertices.push(e);else{f=c.components.length;"OpenLayers.Geometry.LinearRing"==c.CLASS_NAME&&(f-=1);for(d=0;d<f;++d)e=c.components[d],"OpenLayers.Geometry.Point"==e.CLASS_NAME?(e=new OpenLayers.Feature.Vector(e,null,b.virtualStyle),e._sketch=!0,e.renderIntent=b.vertexRenderIntent,b.vertices.push(e)):a(e);if(b.createVertices&&"OpenLayers.Geometry.MultiPoint"!=c.CLASS_NAME)for(d=0,f=
c.components.length;d<f-1;++d){e=c.components[d];var g=c.components[d+1];"OpenLayers.Geometry.Point"==e.CLASS_NAME&&"OpenLayers.Geometry.Point"==g.CLASS_NAME&&(e=new OpenLayers.Feature.Vector(new OpenLayers.Geometry.Point((e.x+g.x)/2,(e.y+g.y)/2),null,b.virtualStyle),e.geometry.parent=c,e._index=d+1,e._sketch=!0,b.virtualVertices.push(e))}}}this.vertices=[];this.virtualVertices=[];var b=this;a.call(this,this.feature.geometry);this.layer.addFeatures(this.virtualVertices,{silent:!0});this.layer.addFeatures(this.vertices,
{silent:!0})},collectDragHandle:function(){var a=this.feature.geometry,b=a.getBounds().getCenterLonLat(),b=new OpenLayers.Geometry.Point(b.lon,b.lat),c=new OpenLayers.Feature.Vector(b,null,this.virtualStyle);b.move=function(b,c){OpenLayers.Geometry.Point.prototype.move.call(this,b,c);a.move(b,c)};c._sketch=!0;this.dragHandle=c;this.dragHandle.renderIntent=this.vertexRenderIntent;this.layer.addFeatures([this.dragHandle],{silent:!0})},collectRadiusHandle:function(){var a=this.feature.geometry,b=a.getBounds(),
c=b.getCenterLonLat(),d=new OpenLayers.Geometry.Point(c.lon,c.lat),b=new OpenLayers.Geometry.Point(b.right,b.bottom),c=new OpenLayers.Feature.Vector(b),e=this.mode&OpenLayers.Control.ModifyFeature.RESIZE,f=this.mode&OpenLayers.Control.ModifyFeature.RESHAPE,g=this.mode&OpenLayers.Control.ModifyFeature.ROTATE;b.move=function(b,c){OpenLayers.Geometry.Point.prototype.move.call(this,b,c);var l=this.x-d.x,m=this.y-d.y,p=l-b,n=m-c;if(g){var q=Math.atan2(n,p),q=Math.atan2(m,l)-q,q=q*(180/Math.PI);a.rotate(q,
d)}if(e){var r;f?(m/=n,r=l/p/m):(p=Math.sqrt(p*p+n*n),m=Math.sqrt(l*l+m*m)/p);a.resize(m,d,r)}};c._sketch=!0;this.radiusHandle=c;this.radiusHandle.renderIntent=this.vertexRenderIntent;this.layer.addFeatures([this.radiusHandle],{silent:!0})},setMap:function(a){this.standalone||this.selectControl.setMap(a);this.dragControl.setMap(a);OpenLayers.Control.prototype.setMap.apply(this,arguments)},CLASS_NAME:"OpenLayers.Control.ModifyFeature"});OpenLayers.Control.ModifyFeature.RESHAPE=1;
OpenLayers.Control.ModifyFeature.RESIZE=2;OpenLayers.Control.ModifyFeature.ROTATE=4;OpenLayers.Control.ModifyFeature.DRAG=8;
...
b=b.replace("{culture}",this.culture);this.url=[];for(var c=0;c<a.imageUrlSubdomains.length;++c)this.url.push(b.replace("{subdomain}",a.imageUrlSubdomains[c]));this.addOptions({maxResolution:Math.min(this.serverResolutions[a.zoomMin],this.maxResolution||Number.POSITIVE_INFINITY),numZoomLevels:Math.min(a.zoomMax+1-a.zoomMin,this.numZoomLevels)},!0)},getURL:function(a){if(this.url){var b=this.getXYZ(a);a=b.x;for(var c=b.y,b=b.z,d=[],e=b;0<e;--e){var f="0",g=1<<e-1;0!=(a&g)&&f++;0!=(c&g)&&(f++,f++);
d.push(f)}d=d.join("");a=this.selectUrl(""+a+c+b,this.url);return OpenLayers.String.format(a,{quadkey:d})}},updateAttribution:function(){var a=this.metadata;if(a.resourceSets&&this.map&&this.map.center){var b=a.resourceSets[0].resources[0],c=this.map.getExtent().transform(this.map.getProjectionObject(),new OpenLayers.Projection("EPSG:4326")),b=b.imageryProviders,d=OpenLayers.Util.indexOf(this.serverResolutions,this.getServerResolution()),e="",f,g,h,k,l,m,p;g=0;for(h=b.length;g<h;++g)for(f=b[g],k=
0,l=f.coverageAreas.length;k<l;++k)p=f.coverageAreas[k],m=OpenLayers.Bounds.fromArray(p.bbox,!0),c.intersectsBounds(m)&&d<=p.zoomMax&&d>=p.zoomMin&&(e+=f.attribution+" ");this.attribution=OpenLayers.String.format(this.attributionTemplate,{type:this.type.toLowerCase(),logo:a.brandLogoUri,copyrights:e});this.map&&this.map.events.triggerEvent("changelayer",{layer:this,property:"attribution"})}},setMap:function(){OpenLayers.Layer.XYZ.prototype.setMap.apply(this,arguments);this.updateAttribution();this.map.events.register("moveend",
this,this.updateAttribution)},clone:function(a){null==a&&(a=new OpenLayers.Layer.Bing(this.options));return OpenLayers.Layer.XYZ.prototype.clone.apply(this,[a])},destroy:function(){this.map&&this.map.events.unregister("moveend",this,this.updateAttribution);OpenLayers.Layer.XYZ.prototype.destroy.apply(this,arguments)},CLASS_NAME:"OpenLayers.Layer.Bing"});
...
OpenLayers.Layer.TMS=OpenLayers.Class(OpenLayers.Layer.Grid,{serviceVersion:"1.0.0",layername:null,type:null,isBaseLayer:!0,tileOrigin:null,serverResolutions:null,zoomOffset:0,initialize:function(a,b,c){var d=[];d.push(a,b,{},c);OpenLayers.Layer.Grid.prototype.initialize.apply(this,d)},clone:function(a){null==a&&(a=new OpenLayers.Layer.TMS(this.name,this.url,this.getOptions()));return OpenLayers.Layer.Grid.prototype.clone.apply(this,[a])},getURL:function(a){a=this.adjustBounds(a);var b=this.getServerResolution(),
...
{node:this.getGeoTolerance(a.nodeTolerance,c),vertex:this.getGeoTolerance(a.vertexTolerance,c),edge:this.getGeoTolerance(a.edgeTolerance,c)},d=Math.max(c.node,c.vertex,c.edge),e={rank:Number.POSITIVE_INFINITY,dist:Number.POSITIVE_INFINITY},f=!1,g=a.layer.features,h,k,l,m,p,n,q=this.precedence.length,r=new OpenLayers.LonLat(b.x,b.y),v=0,w=g.length;v<w;++v)if(h=g[v],h!==this.feature&&!h._sketch&&(h.state!==OpenLayers.State.DELETE&&(!a.filter||a.filter.evaluate(h)))&&h.atPoint(r,d,d))for(var x=0,D=Math.min(e.rank+
1,q);x<D;++x)if(k=this.precedence[x],a[k])if("edge"===k){if(l=h.geometry.distanceTo(b,{details:!0}),p=l.distance,p<=c[k]&&p<e.dist){e={rank:x,dist:p,x:l.x0,y:l.y0};f=!0;break}}else{l=h.geometry.getVertices("node"===k);n=!1;for(var C=0,K=l.length;C<K;++C)if(m=l[C],p=m.distanceTo(b),p<=c[k]&&(x<e.rank||x===e.rank&&p<e.dist))e={rank:x,dist:p,x:m.x,y:m.y},n=f=!0;if(n)break}return f?e:null},getGeoTolerance:function(a,b){b!==this.resolution&&(this.resolution=b,this.geoToleranceCache={});var c=this.geoToleranceCache[a];
void 0===c&&(c=a*b,this.geoToleranceCache[a]=c);return c},destroy:function(){this.active&&this.deactivate();delete this.layer;delete this.targets;OpenLayers.Control.prototype.destroy.call(this)},CLASS_NAME:"OpenLayers.Control.Snapping"});
...
(a[1]||a[7])){b=parseInt(a[1],10)||0;var c=parseInt(a[2],10)-1||0,d=parseInt(a[3],10)||1;b=new Date(Date.UTC(b,c,d));if(c=a[7]){var d=parseInt(a[4],10),e=parseInt(a[5],10),f=parseFloat(a[6]),g=f|0,f=Math.round(1E3*(f-g));b.setUTCHours(d,e,g,f);"Z"!==c&&(c=parseInt(c,10),a=parseInt(a[8],10)||0,b=new Date(b.getTime()+-1E3*(3600*c+60*a)))}}else b=new Date("invalid");return b}};
(function(){function a(){this._object=f&&!k?new f:new window.ActiveXObject("Microsoft.XMLHTTP");this._listeners=[]}function b(){return new a}function c(a){b.onreadystatechange&&b.onreadystatechange.apply(a);a.dispatchEvent({type:"readystatechange",bubbles:!1,cancelable:!1,timeStamp:new Date+0})}function d(a){try{a.responseText=a._object.responseText}catch(b){}try{var c=a._object,d=c.responseXML,e=c.responseText;h&&e&&(d&&!d.documentElement&&c.getResponseHeader("Content-Type").match(/[^\/]+\/[^\+]+\+xml/))&&
(d=new window.ActiveXObject("Microsoft.XMLDOM"),d.async=!1,d.validateOnParse=!1,d.loadXML(e));a.responseXML=d&&(h&&0!=d.parseError||!d.documentElement||d.documentElement&&"parsererror"==d.documentElement.tagName)?null:d}catch(f){}try{a.status=a._object.status}catch(g){}try{a.statusText=a._object.statusText}catch(k){}}function e(a){a._object.onreadystatechange=new window.Function}var f=window.XMLHttpRequest,g=!!window.controllers,h=window.document.all&&!window.opera,k=h&&window.navigator.userAgent.match(/MSIE 7.0/);
...
v=this.readyState,w;h&&k&&(w=function(){v!=b.DONE&&(e(r),r.abort())},window.attachEvent("onunload",w));b.onopen&&b.onopen.apply(this,arguments);4<arguments.length?this._object.open(a,f,k,n,q):3<arguments.length?this._object.open(a,f,k,n):this._object.open(a,f,k);this.readyState=b.OPENED;c(this);this._object.onreadystatechange=function(){if(!g||k)r.readyState=r._object.readyState,d(r),r._aborted?r.readyState=b.UNSENT:(r.readyState==b.DONE&&(delete r._data,e(r),h&&k&&window.detachEvent("onunload",w)),
v!=r.readyState&&c(r),v=r.readyState)}};b.prototype.send=function(a){b.onsend&&b.onsend.apply(this,arguments);arguments.length||(a=null);a&&a.nodeType&&(a=window.XMLSerializer?(new window.XMLSerializer).serializeToString(a):a.xml,this._headers["Content-Type"]||this._object.setRequestHeader("Content-Type","application/xml"));this._data=a;a:if(this._object.send(this._data),g&&!this._async)for(this.readyState=b.OPENED,d(this);this.readyState<b.DONE;)if(this.readyState++,c(this),this._aborted)break a};
...
c=c.replace(this.regExes.removeSpace,"");a=c.split(",")}if(1<a.length)2==a.length&&(a[2]=null),b=new OpenLayers.Geometry.Point(a[0],a[1],a[2]);else throw"Bad coordinate string: "+c;return b},linestring:function(a,b){var c=this.getElementsByTagNameNS(a,this.internalns,"coordinates"),d=null;if(0<c.length){for(var c=this.getChildValue(c[0]),c=c.replace(this.regExes.trimSpace,""),c=c.replace(this.regExes.trimComma,","),d=c.split(this.regExes.splitSpace),e=d.length,f=Array(e),g,h,k=0;k<e;++k)if(g=d[k].split(","),
...
up:function(a){this.mouseDown=!1;this.stoppedDown=this.stopDown;return!this.checkModifiers(a)||this.lastUp&&this.lastUp.equals(a.xy)||!this.lastDown||!this.passesTolerance(this.lastDown,a.xy,this.pixelTolerance)?!0:(this.touch&&this.modifyFeature(a.xy),this.persist&&this.destroyPersistedFeature(),this.lastUp=a.xy,this.finalize(),!this.stopUp)},mouseout:function(a){OpenLayers.Util.mouseLeft(a,this.map.viewPortDiv)&&(this.stoppedDown=this.stopDown,this.mouseDown=!1)},passesTolerance:function(a,b,c){var d=
!0;null!=c&&a&&b&&a.distanceTo(b)>c&&(d=!1);return d},CLASS_NAME:"OpenLayers.Handler.Point"});
...
OpenLayers.Spherical.computeDistanceBetween=function(a,b,c){c=c||OpenLayers.Spherical.DEFAULT_RADIUS;var d=Math.sin(Math.PI*(b.lon-a.lon)/360),e=Math.sin(Math.PI*(b.lat-a.lat)/360);a=e*e+d*d*Math.cos(Math.PI*a.lat/180)*Math.cos(Math.PI*b.lat/180);return 2*c*Math.atan2(Math.sqrt(a),Math.sqrt(1-a))};
...
2)/2+c*a,m=l*d,l=l*e,p,n;p=!1;0>=-this.deceleration*a+c&&(OpenLayers.Animation.stop(this.timerId),this.timerId=null,p=!0);a=m-g;n=l-h;g=m;h=l;b(a,n,p)}},this))},CLASS_NAME:"OpenLayers.Kinetic"});
...
a.name,b);a.title&&this.writeNode("Title",a.title,b);a.description&&this.writeNode("Abstract",a.description,b);a.isDefault&&this.writeNode("IsDefault",a.isDefault,b);if(this.multipleSymbolizers&&a.rules){for(var c={0:[]},d=[0],e,f,g,h,k,l=0,m=a.rules.length;l<m;++l)if(e=a.rules[l],e.symbolizers){f={};for(var p=0,n=e.symbolizers.length;p<n;++p)g=e.symbolizers[p],h=g.zIndex,h in f||(k=e.clone(),k.symbolizers=[],f[h]=k),f[h].symbolizers.push(g.clone());for(h in f)h in c||(d.push(h),c[h]=[]),c[h].push(f[h])}else c[0].push(e.clone());
...
b,c){b=b||a._style;c=c||a._options;var d=parseFloat(a.getAttributeNS(null,"r")),e=1,f;!1!==b.graphic&&b.graphicTitle&&(a.setAttributeNS(null,"title",b.graphicTitle),d=a.getElementsByTagName("title"),0<d.length?d[0].firstChild.textContent=b.graphicTitle:(d=this.nodeFactory(null,"title"),d.textContent=b.graphicTitle,a.appendChild(d)));if("OpenLayers.Geometry.Point"==a._geometryClass&&d){a.style.visibility="";if(!1===b.graphic)a.style.visibility="hidden";else if(b.externalGraphic){f=this.getPosition(a);
b.graphicWidth&&b.graphicHeight&&a.setAttributeNS(null,"preserveAspectRatio","none");var d=b.graphicWidth||b.graphicHeight,g=b.graphicHeight||b.graphicWidth,d=d?d:2*b.pointRadius,g=g?g:2*b.pointRadius,h=void 0!=b.graphicYOffset?b.graphicYOffset:-(0.5*g),k=b.graphicOpacity||b.fillOpacity;a.setAttributeNS(null,"x",(f.x+(void 0!=b.graphicXOffset?b.graphicXOffset:-(0.5*d))).toFixed());a.setAttributeNS(null,"y",(f.y+h).toFixed());a.setAttributeNS(null,"width",d);a.setAttributeNS(null,"height",g);a.setAttributeNS(this.xlinkns,
"href",b.externalGraphic);a.setAttributeNS(null,"style","opacity: "+k);a.onclick=OpenLayers.Renderer.SVG.preventDefault}else if(this.isComplexSymbol(b.graphicName)){var d=3*b.pointRadius,g=2*d,l=this.importSymbol(b.graphicName);f=this.getPosition(a);e=3*this.symbolMetrics[l.id][0]/g;h=a.parentNode;k=a.nextSibling;h&&h.removeChild(a);a.firstChild&&a.removeChild(a.firstChild);a.appendChild(l.firstChild.cloneNode(!0));a.setAttributeNS(null,"viewBox",l.getAttributeNS(null,"viewBox"));a.setAttributeNS(null,
"width",g);a.setAttributeNS(null,"height",g);a.setAttributeNS(null,"x",f.x-d);a.setAttributeNS(null,"y",f.y-d);k?h.insertBefore(a,k):h&&h.appendChild(a)}else a.setAttributeNS(null,"r",b.pointRadius);d=b.rotation;void 0===d&&void 0===a._rotation||!f||(a._rotation=d,d|=0,"svg"!==a.nodeName?a.setAttributeNS(null,"transform","rotate("+d+" "+f.x+" "+f.y+")"):(f=this.symbolMetrics[l.id],a.firstChild.setAttributeNS(null,"transform","rotate("+d+" "+f[1]+" "+f[2]+")")))}c.isFilled?(a.setAttributeNS(null,"fill",
b.fillColor),a.setAttributeNS(null,"fill-opacity",b.fillOpacity)):a.setAttributeNS(null,"fill","none");c.isStroked?(a.setAttributeNS(null,"stroke",b.strokeColor),a.setAttributeNS(null,"stroke-opacity",b.strokeOpacity),a.setAttributeNS(null,"stroke-width",b.strokeWidth*e),a.setAttributeNS(null,"stroke-linecap",b.strokeLinecap||"round"),a.setAttributeNS(null,"stroke-linejoin","round"),b.strokeDashstyle&&a.setAttributeNS(null,"stroke-dasharray",this.dashStyle(b,e))):a.setAttributeNS(null,"stroke","none");
...
b.label.split("\n"),k=h.length;f.childNodes.length>k;)f.removeChild(f.lastChild);for(var l=0;l<k;l++){var m=this.nodeFactory(a+d+"_tspan_"+l,"tspan");!0===b.labelSelect&&(m._featureId=a,m._geometry=c,m._geometryClass=c.CLASS_NAME);!1===OpenLayers.IS_GECKO&&m.setAttributeNS(null,"baseline-shift",OpenLayers.Renderer.SVG.LABEL_VSHIFT[g[1]]||"-35%");m.setAttribute("x",e);if(0==l){var p=OpenLayers.Renderer.SVG.LABEL_VFACTOR[g[1]];null==p&&(p=-0.5);m.setAttribute("dy",p*(k-1)+"em")}else m.setAttribute("dy",
...
this.eTop.innerHTML=d+" "+f)}},CLASS_NAME:"OpenLayers.Control.ScaleLine"});
...
h=new OpenLayers.Geometry.Point(d,e),f=a.center;this.rotate(-a.rotation,f);h.rotate(-a.rotation,f);var k=this.x-f.x,l=this.y-f.y,m=k-(this.x-h.x),p=l-(this.y-h.y);a.irregular&&!a._setfeature&&(k-=(this.x-h.x)/2,l-=(this.y-h.y)/2);this.x=d;this.y=e;h=1;g?(l=1E-5>Math.abs(p)?1:l/p,h=(1E-5>Math.abs(m)?1:k/m)/l):(m=Math.sqrt(m*m+p*p),l=Math.sqrt(k*k+l*l)/m);a._moving=!0;a.box.geometry.rotate(-a.rotation,f);delete a._moving;a.box.geometry.resize(l,f,h);a.box.geometry.rotate(a.rotation,f);a.transformFeature({scale:l,
...
360;d=a.rotation%f;if(Math.abs(a._angle)>=f||0!==d)d=Math.round(a._angle/f)*f-d,a._angle=0,a.box.geometry.rotate(d,g),a.transformFeature({rotation:d})}},g=Array(8),h=Array(4),k,l,m,p="sw s se e ne n nw w".split(" "),n=0;8>n;++n)k=this.box.geometry.components[n],l=new OpenLayers.Feature.Vector(k.clone(),{role:p[n]+"-resize"},"string"==typeof this.renderIntent?null:this.renderIntent),0==n%2&&(m=new OpenLayers.Feature.Vector(k.clone(),{role:p[n]+"-rotate"},"string"==typeof this.rotationHandleSymbolizer?
...
success:this.parseData,failure:function(){this.events.triggerEvent("loadend")},scope:this}),this.loaded=!0)},moveTo:function(a,b,c){OpenLayers.Layer.Markers.prototype.moveTo.apply(this,arguments);this.visibility&&!this.loaded&&this.loadText()},parseData:function(a){a=a.responseText;var b={};OpenLayers.Util.extend(b,this.formatOptions);this.map&&!this.projection.equals(this.map.getProjectionObject())&&(b.externalProjection=this.projection,b.internalProjection=this.map.getProjectionObject());a=(new OpenLayers.Format.Text(b)).read(a);
...
scope:b});this.map.addLayer(b)}return b},createSLD:function(a,b,c){for(var d={version:"1.0.0",namedLayers:{}},e=(""+a.params.LAYERS).split(","),f=0,g=e.length;f<g;f++){var h=e[f];d.namedLayers[h]={name:h,userStyles:[]};var k=this.selectionSymbolizer,l=c[f];0<=l.type.indexOf("Polygon")?k={Polygon:this.selectionSymbolizer.Polygon}:0<=l.type.indexOf("LineString")?k={Line:this.selectionSymbolizer.Line}:0<=l.type.indexOf("Point")&&(k={Point:this.selectionSymbolizer.Point});d.namedLayers[h].userStyles.push({name:"default",
rules:[new OpenLayers.Rule({symbolizer:k,filter:b[f],maxScaleDenominator:a.options.minScale})]})}return(new OpenLayers.Format.SLD({srsName:this.map.getProjection()})).write(d)},parseDescribeLayer:function(a){var b=new OpenLayers.Format.WMSDescribeLayer,c=a.responseXML;c&&c.documentElement||(c=a.responseText);a=b.read(c);for(var b=[],c=null,d=0,e=a.length;d<e;d++)"WFS"==a[d].owsType&&(b.push(a[d].typeName),c=a[d].owsURL);OpenLayers.Request.GET({url:c,params:{SERVICE:"WFS",TYPENAME:b.toString(),REQUEST:"DescribeFeatureType",
VERSION:"1.0.0"},callback:function(a){var b=new OpenLayers.Format.WFSDescribeFeatureType,c=a.responseXML;c&&c.documentElement||(c=a.responseText);this.control.wfsCache[this.layer.id]=b.read(c);this.control._queue&&this.control.applySelection()},scope:this})},getGeometryAttributes:function(a){var b=[];a=this.wfsCache[a.id];for(var c=0,d=a.featureTypes.length;c<d;c++)for(var e=a.featureTypes[c].properties,f=0,g=e.length;f<g;f++){var h=e[f],k=h.type;(0<=k.indexOf("LineString")||0<=k.indexOf("GeometryAssociationType")||
...
OpenLayers.Util.applyDefaults(this.params,this.FOLDER_PARAMS):OpenLayers.Util.applyDefaults(this.params,this.TILE_PARAMS),this.setTileSize(this.defaultSize))},clone:function(a){null==a&&(a=new OpenLayers.Layer.MapGuide(this.name,this.url,this.params,this.getOptions()));return OpenLayers.Layer.Grid.prototype.clone.apply(this,[a])},getURL:function(a){var b;b=a.getCenterLonLat();var c=this.map.getSize();this.singleTile?(a={setdisplaydpi:OpenLayers.DOTS_PER_INCH,setdisplayheight:c.h*this.ratio,setdisplaywidth:c.w*
...
arguments)},setBackgroundColor:function(){},setBorder:function(){},setOpacity:function(){},setSize:function(a){OpenLayers.Popup.Anchored.prototype.setSize.apply(this,arguments);this.updateBlocks()},updateRelativePosition:function(){this.padding=this.positionBlocks[this.relativePosition].padding;if(this.closeDiv){var a=this.getContentDivPadding();this.closeDiv.style.right=a.right+this.padding.right+"px";this.closeDiv.style.top=a.top+this.padding.top+"px"}this.updateBlocks()},calculateNewPx:function(a){return OpenLayers.Popup.Anchored.prototype.calculateNewPx.apply(this,
arguments).offset(this.positionBlocks[this.relativePosition].offset)},createBlocks:function(){this.blocks=[];var a=null,b;for(b in this.positionBlocks){a=b;break}a=this.positionBlocks[a];for(b=0;b<a.blocks.length;b++){var c={};this.blocks.push(c);c.div=OpenLayers.Util.createDiv(this.id+"_FrameDecorationDiv_"+b,null,null,null,"absolute",null,"hidden",null);c.image=(this.isAlphaImage?OpenLayers.Util.createAlphaImageDiv:OpenLayers.Util.createImage)(this.id+"_FrameDecorationImg_"+b,null,this.imageSize,
this.imageSrc,"absolute",null,null,null);c.div.appendChild(c.image);this.groupDiv.appendChild(c.div)}},updateBlocks:function(){this.blocks||this.createBlocks();if(this.size&&this.relativePosition){for(var a=this.positionBlocks[this.relativePosition],b=0;b<a.blocks.length;b++){var c=a.blocks[b],d=this.blocks[b],e=c.anchor.left,f=c.anchor.bottom,g=c.anchor.right,h=c.anchor.top,k=isNaN(c.size.w)?this.size.w-(g+e):c.size.w,l=isNaN(c.size.h)?this.size.h-(f+h):c.size.h;d.div.style.width=(0>k?0:k)+"px";
d.div.style.height=(0>l?0:l)+"px";d.div.style.left=null!=e?e+"px":"";d.div.style.bottom=null!=f?f+"px":"";d.div.style.right=null!=g?g+"px":"";d.div.style.top=null!=h?h+"px":"";d.image.style.left=c.position.x+"px";d.image.style.top=c.position.y+"px"}this.contentDiv.style.left=this.padding.left+"px";this.contentDiv.style.top=this.padding.top+"px"}},CLASS_NAME:"OpenLayers.Popup.Framed"});
...
return a}};OpenLayers.Format.SOSCapabilities=OpenLayers.Class(OpenLayers.Format.XML.VersionedOGC,{defaultVersion:"1.0.0",CLASS_NAME:"OpenLayers.Format.SOSCapabilities"});
...
(this.params.FORMAT=OpenLayers.Util.alphaHack()?"gif":"png"))},clone:function(a){null==a&&(a=new OpenLayers.Layer.ArcGIS93Rest(this.name,this.url,this.params,this.getOptions()));return OpenLayers.Layer.Grid.prototype.clone.apply(this,[a])},getURL:function(a){a=this.adjustBounds(a);var b=this.projection.getCode().split(":"),b=b[b.length-1],c=this.getImageSize();a={BBOX:a.toBBOX(),SIZE:c.w+","+c.h,F:"image",BBOXSR:b,IMAGESR:b};if(this.layerDefs){var b=[],d;for(d in this.layerDefs)this.layerDefs.hasOwnProperty(d)&&
...
OpenLayers.Element.removeClass(this.map.viewPortDiv,"olCursorWait")},scope:this});!0==b.hover&&(this.hoverResponse=c)},selectBestFeature:function(a,b,c){c=c||{};if(a.length){b=new OpenLayers.Geometry.Point(b.lon,b.lat);for(var d,e,f,g=Number.MAX_VALUE,h=0;h<a.length&&!(d=a[h],d.geometry&&(f=b.distanceTo(d.geometry,{edge:!1}),f<g&&(g=f,e=d,0==g)));++h);!0==c.hover?this.hoverSelect(e):this.select(e||a)}},setModifiers:function(a){this.modifiers={multiple:this.multiple||this.multipleKey&&a[this.multipleKey],
toggle:this.toggle||this.toggleKey&&a[this.toggleKey]}},select:function(a){this.modifiers.multiple||this.modifiers.toggle||this.unselectAll();OpenLayers.Util.isArray(a)||(a=[a]);var b=this.events.triggerEvent("beforefeaturesselected",{features:a});if(!1!==b){for(var c=[],d,e=0,f=a.length;e<f;++e)d=a[e],this.features[d.fid||d.id]?this.modifiers.toggle&&this.unselect(this.features[d.fid||d.id]):(b=this.events.triggerEvent("beforefeatureselected",{feature:d}),!1!==b&&(this.features[d.fid||d.id]=d,c.push(d),
this.events.triggerEvent("featureselected",{feature:d})));this.events.triggerEvent("featuresselected",{features:c})}},hoverSelect:function(a){var b=a?a.fid||a.id:null,c=this.hoverFeature?this.hoverFeature.fid||this.hoverFeature.id:null;c&&c!=b&&(this.events.triggerEvent("outfeature",{feature:this.hoverFeature}),this.hoverFeature=null);b&&b!=c&&(this.events.triggerEvent("hoverfeature",{feature:a}),this.hoverFeature=a)},unselect:function(a){delete this.features[a.fid||a.id];this.events.triggerEvent("featureunselected",
...
a.getAttribute("opaque"):null,h=a.getAttribute("noSubsets"),k=a.getAttribute("fixedWidth"),l=a.getAttribute("fixedHeight"),m=c||{},p=OpenLayers.Util.extend;c={nestedLayers:[],styles:c?[].concat(c.styles):[],srs:c?p({},m.srs):{},metadataURLs:[],bbox:c?p({},m.bbox):{},llbbox:m.llbbox,dimensions:c?p({},m.dimensions):{},authorityURLs:c?p({},m.authorityURLs):{},identifiers:{},keywords:[],queryable:f&&""!==f?"1"===f||"true"===f:m.queryable||!1,cascaded:null!==g?parseInt(g):m.cascaded||0,opaque:e?"1"===
...
1].w*this.tierSizeInTiles[a-1].h+this.tileCountUpToTier[a-1])},destroy:function(){OpenLayers.Layer.Grid.prototype.destroy.apply(this,arguments);this.tileCountUpToTier.length=0;this.tierSizeInTiles.length=0;this.tierImageSize.length=0},clone:function(a){null==a&&(a=new OpenLayers.Layer.Zoomify(this.name,this.url,this.size,this.options));return OpenLayers.Layer.Grid.prototype.clone.apply(this,[a])},getURL:function(a){a=this.adjustBounds(a);var b=this.map.getResolution(),c=Math.round((a.left-this.tileOrigin.lon)/
...
return OpenLayers.Layer.Grid.prototype.clone.apply(this,[a])},getURL:function(a){a=this.adjustBounds(a);a=[a.left,a.bottom,a.right,a.top];var b=this.getImageSize();return this.getFullRequestString({mapext:a,imgext:a,map_size:[b.w,b.h],imgx:b.w/2,imgy:b.h/2,imgxy:[b.w,b.h]})},getFullRequestString:function(a,b){var c=null==b?this.url:b,d=OpenLayers.Util.extend({},this.params),d=OpenLayers.Util.extend(d,a),e=OpenLayers.Util.getParameterString(d);OpenLayers.Util.isArray(c)&&(c=this.selectUrl(e,c));var e=
OpenLayers.Util.upperCaseObject(OpenLayers.Util.getParameters(c)),f;for(f in d)f.toUpperCase()in e&&delete d[f];e=OpenLayers.Util.getParameterString(d);d=c;e=e.replace(/,/g,"+");""!=e&&(f=c.charAt(c.length-1),d="&"==f||"?"==f?d+e:-1==c.indexOf("?")?d+("?"+e):d+("&"+e));return d},CLASS_NAME:"OpenLayers.Layer.MapServer"});
...
"olv:shape"}return c},setStyle:function(a,b,c,d){b=b||a._style;c=c||a._options;var e=b.fillColor;if("OpenLayers.Geometry.Point"===a._geometryClass)if(b.externalGraphic){c.isFilled=!0;b.graphicTitle&&(a.title=b.graphicTitle);var e=b.graphicWidth||b.graphicHeight,f=b.graphicHeight||b.graphicWidth,e=e?e:2*b.pointRadius,f=f?f:2*b.pointRadius,g=this.getResolution(),h=void 0!=b.graphicXOffset?b.graphicXOffset:-(0.5*e),k=void 0!=b.graphicYOffset?b.graphicYOffset:-(0.5*f);a.style.left=((d.x-this.featureDx)/
...
d){d=d||a._style;var e=d.rotation||0,f,g;if(d.graphicWidth&&d.graphicHeight){g=Math.max(d.graphicWidth,d.graphicHeight);f=d.graphicWidth/d.graphicHeight;var h=Math.round(d.graphicWidth||g*f),k=Math.round(d.graphicHeight||g);a.style.width=h+"px";a.style.height=k+"px";var l=document.getElementById(a.id+"_image");l||(l=this.createNode("olv:imagedata",a.id+"_image"),a.appendChild(l));l.style.width=h+"px";l.style.height=k+"px";l.src=d.externalGraphic;l.style.filter="progid:DXImageTransform.Microsoft.AlphaImageLoader(src='', sizingMethod='scale')";
...
b,!0)},drawLine:function(a,b,c){this.setNodeDimension(a,b);for(var d=this.getResolution(),e=b.components.length,f=Array(e),g,h,k=0;k<e;k++)g=b.components[k],h=(g.x-this.featureDx)/d-this.offset.x|0,g=g.y/d-this.offset.y|0,f[k]=" "+h+","+g+" l ";a.path="m"+f.join("")+(c?" x e":" e");return a},drawPolygon:function(a,b){this.setNodeDimension(a,b);var c=this.getResolution(),d=[],e,f,g,h,k,l,m,p,n,q;e=0;for(f=b.components.length;e<f;e++){d.push("m");g=b.components[e].components;h=0===e;l=k=null;m=0;for(p=
g.length;m<p;m++)n=g[m],q=(n.x-this.featureDx)/c-this.offset.x|0,n=n.y/c-this.offset.y|0,q=" "+q+","+n,d.push(q),0==m&&d.push(" l"),h||(k?k!=q&&(l?l!=q&&(h=!0):l=q):k=q);d.push(h?" x ":" ")}d.push("e");a.path=d.join("");return a},drawRectangle:function(a,b){var c=this.getResolution();a.style.left=((b.x-this.featureDx)/c-this.offset.x|0)+"px";a.style.top=(b.y/c-this.offset.y|0)+"px";a.style.width=(b.width/c|0)+"px";a.style.height=(b.height/c|0)+"px";return a},drawText:function(a,b,c){var d=this.nodeFactory(a+
...
while(a.containsPixel(l)&&1E3>++d);d=0;k=[f.clone()];h=f.clone();do h=h.offset({x:-g,y:0}),l=OpenLayers.Projection.transform(h.clone(),b,c),k.unshift(h);while(a.containsPixel(l)&&1E3>++d);h=f.clone();do h=h.offset({x:g,y:0}),l=OpenLayers.Projection.transform(h.clone(),b,c),k.push(h);while(a.containsPixel(l)&&1E3>++d);g=[];for(d=0;d<k.length;++d){l=k[d].x;for(var f=[],m=null,p=Math.min(e[0].y,90),h=Math.max(e[e.length-1].y,-90),n=(p-h)/this.numPoints,p=h,h=0;h<=this.numPoints;++h){var q=new OpenLayers.Geometry.Point(l,
p);q.transform(b,c);f.push(q);p+=n;q.y>=a.bottom&&!m&&(m=q)}this.labelled&&(m=new OpenLayers.Geometry.Point(m.x,a.bottom),l={value:l,label:this.labelled?OpenLayers.Util.getFormattedLonLat(l,"lon",this.labelFormat):"",labelAlign:"cb",xOffset:0,yOffset:2},this.gratLayer.addFeatures(new OpenLayers.Feature.Vector(m,l)));f=new OpenLayers.Geometry.LineString(f);g.push(new OpenLayers.Feature.Vector(f))}for(h=0;h<e.length;++h)if(p=e[h].y,!(-90>p||90<p)){f=[];d=k[0].x;n=(k[k.length-1].x-d)/this.numPoints;
l=d;m=null;for(d=0;d<=this.numPoints;++d)q=new OpenLayers.Geometry.Point(l,p),q.transform(b,c),f.push(q),l+=n,q.x<a.right&&(m=q);this.labelled&&(m=new OpenLayers.Geometry.Point(a.right,m.y),l={value:p,label:this.labelled?OpenLayers.Util.getFormattedLonLat(p,"lat",this.labelFormat):"",labelAlign:"rb",xOffset:-2,yOffset:2},this.gratLayer.addFeatures(new OpenLayers.Feature.Vector(m,l)));f=new OpenLayers.Geometry.LineString(f);g.push(new OpenLayers.Feature.Vector(f))}this.gratLayer.addFeatures(g)}},CLASS_NAME:"OpenLayers.Control.Graticule"});
OpenLayers.Layer.UTFGrid=OpenLayers.Class(OpenLayers.Layer.XYZ,{isBaseLayer:!1,projection:new OpenLayers.Projection("EPSG:900913"),useJSONP:!1,tileClass:OpenLayers.Tile.UTFGrid,initialize:function(a){OpenLayers.Layer.Grid.prototype.initialize.apply(this,[a.name,a.url,{},a]);this.tileOptions=OpenLayers.Util.extend({utfgridResolution:this.utfgridResolution},this.tileOptions)},clone:function(a){null==a&&(a=new OpenLayers.Layer.UTFGrid(this.getOptions()));return OpenLayers.Layer.Grid.prototype.clone.apply(this,
...
b+"/${z}/${y}/${x}."+this.type);b=OpenLayers.String.format(b,{x:c,y:d,z:a});return OpenLayers.Util.urlAppend(b,OpenLayers.Util.getParameterString(this.params))},zeroPad:function(a,b,c){for(a=a.toString(c||10);a.length<b;)a="0"+a;return a},CLASS_NAME:"OpenLayers.Layer.ArcGISCache"});
...
g={},h={RPAREN:3,LOGICAL:2,COMPARISON:1},k;for(k in d)d.hasOwnProperty(k)&&(e[d[k]]=k);for(k in f)f.hasOwnProperty(k)&&(g[f[k]]=k);return OpenLayers.Class(OpenLayers.Format,{read:function(d){var e=d;d=[];var f,g=["NOT","GEOMETRY","SPATIAL","PROPERTY","LPAREN"];do{a:{f=g;for(var h=void 0,k=f.length,h=0;h<k;h++){var g=f[h],v=b[g]instanceof RegExp?b[g].exec(e):(0,b[g])(e);if(v){f=v[0];e=e.substr(f.length).replace(/^\s*/,"");f={type:g,text:f,remainder:e};break a}}d="ERROR: In parsing: ["+e+"], expected one of: ";
...
isEligible:function(a){return a.geometry?a.state!==OpenLayers.State.DELETE&&"function"===typeof a.geometry.split&&this.feature!==a&&(!this.targetFilter||this.targetFilter.evaluate(a.attributes)):!1},considerSplit:function(a){var b=!1,c=!1;if(!this.sourceFilter||this.sourceFilter.evaluate(a.attributes)){for(var d=this.layer&&this.layer.features||[],e,f,g=[],h=[],k=this.layer===this.source&&this.mutual,l={edge:this.edge,tolerance:this.tolerance,mutual:k},m=[a.geometry],p,n,q,r=0,v=d.length;r<v;++r)if(p=
d[r],this.isEligible(p)){n=[p.geometry];for(var w=0;w<m.length;++w){q=m[w];for(var x=0;x<n.length;++x)if(e=n[x],q.getBounds().intersectsBounds(e.getBounds())&&(e=q.split(e,l)))if(f=this.events.triggerEvent("beforesplit",{source:a,target:p}),!1!==f&&(k&&(f=e[0],1<f.length&&(f.unshift(w,1),Array.prototype.splice.apply(m,f),w+=f.length-3),e=e[1]),1<e.length))e.unshift(x,1),Array.prototype.splice.apply(n,e),x+=e.length-3}n&&1<n.length&&(this.geomsToFeatures(p,n),this.events.triggerEvent("split",{original:p,
features:n}),Array.prototype.push.apply(g,n),h.push(p),c=!0)}m&&1<m.length&&(this.geomsToFeatures(a,m),this.events.triggerEvent("split",{original:a,features:m}),Array.prototype.push.apply(g,m),h.push(a),b=!0);if(b||c){if(this.deferDelete){d=[];r=0;for(v=h.length;r<v;++r)c=h[r],c.state===OpenLayers.State.INSERT?d.push(c):(c.state=OpenLayers.State.DELETE,this.layer.drawFeature(c));this.layer.destroyFeatures(d,{silent:!0});r=0;for(v=g.length;r<v;++r)g[r].state=OpenLayers.State.INSERT}else this.layer.destroyFeatures(h,
...
if(0<d.length){c={};if(e=d[0].getAttribute("type"))c.type=e;(e=d[0].getAttribute("src"))?c.src=e:(c.value="text"==c.type||"html"==c.type||null==c.type?this.getFirstChildValue(a,f,"content",null):"xhtml"==c.type||c.type.match(/(\+|\/)xml$/)?this.getChildEl(d[0]):this.getFirstChildValue(a,f,"content",null),b.content=c)}this.parsePersonConstructs(a,"contributor",b);b.id=this.getFirstChildValue(a,f,"id",null);d=this.getElementsByTagNameNS(a,f,"link");0<d.length&&(b.links=Array(d.length));for(var k=["rel",
"type","hreflang","title","length"],g=0,h=d.length;g<h;g++){c={};c.href=d[g].getAttribute("href");for(var l=0,m=k.length;l<m;l++)(e=d[g].getAttribute(k[l]))&&(c[k[l]]=e);b.links[g]=c}if(c=this.getFirstChildValue(a,f,"published",null))b.published=c;if(c=this.getFirstChildValue(a,f,"rights",null))b.rights=c;if(c=this.getFirstChildValue(a,f,"summary",null))b.summary=c;b.title=this.getFirstChildValue(a,f,"title",null);b.updated=this.getFirstChildValue(a,f,"updated",null);c={title:b.title,description:b.summary,
...
c)}c=c.components;if((d=this.getElementsByTagNameNS(a,b,"point"))&&0<d.length)for(e=0,f=d.length;e<f;e++){var g=OpenLayers.String.trim(d[e].firstChild.nodeValue).split(/\s+/);2!=g.length&&(g=OpenLayers.String.trim(d[e].firstChild.nodeValue).split(/\s*,\s*/));c.push(new OpenLayers.Geometry.Point(g[1],g[0]))}var h=this.getElementsByTagNameNS(a,b,"line");if(h&&0<h.length)for(var k,e=0,f=h.length;e<f;e++){d=OpenLayers.String.trim(h[e].firstChild.nodeValue).split(/\s+/);k=[];for(var l=0,m=d.length;l<m;l+=
2)g=new OpenLayers.Geometry.Point(d[l+1],d[l]),k.push(g);c.push(new OpenLayers.Geometry.LineString(k))}if((a=this.getElementsByTagNameNS(a,b,"polygon"))&&0<a.length)for(e=0,f=a.length;e<f;e++){d=OpenLayers.String.trim(a[e].firstChild.nodeValue).split(/\s+/);k=[];l=0;for(m=d.length;l<m;l+=2)g=new OpenLayers.Geometry.Point(d[l+1],d[l]),k.push(g);c.push(new OpenLayers.Geometry.Polygon([new OpenLayers.Geometry.LinearRing(c)]))}if(this.internalProjection&&this.externalProjection)for(e=0,f=c.length;e<f;e++)c[e]&&
c[e].transform(this.externalProjection,this.internalProjection);return c},parsePersonConstructs:function(a,b,c){var d=[],e=this.namespaces.atom;a=this.getElementsByTagNameNS(a,e,b);for(var f=["uri","email"],g=0,h=a.length;g<h;g++){var k={};k.name=this.getFirstChildValue(a[g],e,"name",null);for(var l=0,m=f.length;l<m;l++){var p=this.getFirstChildValue(a[g],e,f[l],null);p&&(k[f[l]]=p)}d.push(k)}0<d.length&&(c[b+"s"]=d)},CLASS_NAME:"OpenLayers.Format.Atom"});
...
jc2cui.mapWidget.infoWindow=function(){function a(){var a;!d.containment||d.containment instanceof jQuery||(d.containment=$(d.containment));c=$('<div id="infoWindow" class="infoWindow"><span class="closeInfoWindow"></span><div id="infoWindowContent" class="infoWindowContent"></div></div>').appendTo(d.containment||$("body")).draggable({cancel:"#infoWindowContent",containment:d.containment,cursor:"move"}).resizable({containment:d.containment,stop:function(a,b){g=!0}});a=$(".closeInfoWindow",c).hover(function(){a.addClass("closeInfoWindowOver")},
function(){a.removeClass("closeInfoWindowOver")}).click(function(){jc2cui.mapWidget.infoWindow.close()});e=$("#infoWindowContent");d.zIndex&&c.css("z-index",d.zIndex)}function b(){if(d.containment){var a=g?Math.min(d.containment.innerHeight()-(c.outerHeight()-c.innerHeight())-18,c.height()):Math.min(500,0.6*d.containment.height()),b=g?Math.min(d.containment.innerWidth()-(c.outerWidth()-c.innerWidth())-12,c.width()):Math.min(542,0.6*d.containment.width());c.css("height",Math.max(10,a)+"px");c.css("width",
Math.max(10,b)+"px");if(d.containment){var a=parseInt(c.css("top").replace("px",""),10),b=parseInt(c.css("left").replace("px",""),10),e=d.containment.position();a+c.outerHeight()>d.containment.height()+e.top&&c.css("top",Math.max(e.top,d.containment.height()-c.outerHeight()+e.top)+"px");b+c.outerWidth()>=d.containment.width()&&c.css("left",Math.max(0,d.containment.width()-c.outerWidth())+"px")}}}var c,d,e,f=!0,g=!1,h;return{init:function(a){d=a||{}},open:function(k,l){c||a();k.content&&("string"===
typeof k.content?e.html(k.content):(e.empty(),e.append(k.content)),$("a",e).addClass("external").attr({target:"_blank"}));e.text().length&&(k.width&&(c.css("width",k.width),g=!0),k.height&&(c.css("height",k.height),g=!0),k.bgColor&&(c.css("background-color",k.bgColor),g=!0),k.textColor&&(c.css("color",k.textColor),g=!0),h=l,c.show(),e.scrollTop(0),f&&(f=!1,b(),d.containment&&(c.css("left",Math.max(0,(d.containment.width()-c.outerWidth())/2+d.containment.scrollLeft())+"px"),c.css("top",Math.max(0,
(d.containment.height()-c.outerHeight())/2+d.containment.scrollTop())+"px"))))},close:function(){h=null;c&&c.hide()},setPosition:function(){},checkResize:function(){c&&b()},getMapItem:function(){return h}}}();
...
3===b.length&&(a=d(b[0].toString(16)),c=d(b[1].toString(16)),b=d(b[2].toString(16)),a="#"+a+c+b)}else a=null;return a},e=function(e){b.control=a("<div class='color-picker'></div>");var f=function(a){a.bind({click:function(e){e=a.css("background-color");e=(e=d(e))||"transparent";b.selector.css("background-color",e);c(!0,e)},mouseover:function(b){a.css("border-color","#598FEF")},mouseout:function(b){a.css("border-color","#000")}});b.control.append(a)};a.each(a.fn.colorPicker.defaultColors,function(b){b=
a("<div class='color_swatch'>&nbsp;</div>");b.css("background-color","#"+this);f(b)});f(a("<div class='nocolor'>transparent</div>"));a("body").append(b.control);e&&(b.iframeShim=document.createElement("iframe"),b.iframeShim.frameBorder=0,b.iframeShim.scrolling="no",b.iframeShim.src="javascript:false;",b.iframeShim.style.position="absolute",b.iframeShim.style.width=b.control.width()+"px",b.iframeShim.style.height=b.control.height()+"px",a("body").append(b.iframeShim))},f=function(d){d.target!==b.control&&
a(d.target).parent()[0]!==b.control[0]&&c()};c=function(c,d){b.control.stop(!0);c?b.control.slideUp("slow",function(){b.control.css("height","")}):(b.control.hide(),b.control.css("height",""));a("body").unbind("mousedown",f);b.iframeShim&&(b.iframeShim.style.zIndex=-500);b.callback&&(b.callback(d),delete b.callback)};a.fn.colorPicker=function(d,h,k){var l=this;return this.css("background-color",d).bind("mouseover",function(a){l.css("border-color","#598FEF")}).bind("mouseout",function(a){l.css("border-color",
"#000")}).click(function(){b.selector=l;b.control||e(k);c();var d=l.offset(),g=Math.max(0,d.top-b.control.height()),n=a(window),d=Math.max(0,d.left),g=Math.min(g,n.height()-b.control.height()),d=Math.min(d,n.width()-b.control.width());b.control.css({left:d+"px",top:g+"px"});b.iframeShim&&(b.iframeShim.style.left=d+"px",b.iframeShim.style.top=g+"px",b.iframeShim.style.zIndex=b.control.css("z-index")-1);b.control.slideDown("slow");b.callback=h;a("body").bind("mousedown",f)})};a.fn.colorPicker.hide=
function(a){c(a)};a.fn.colorPicker.defaultColors="000000 993300 333300 000080 333399 333333 800000 FF6600 808000 008000 008080 0000FF 666699 808080 FF0000 FF9900 99CC00 339966 33CCCC 3366FF 800080 999999 FF00FF FFCC00 FFFF00 00FF00 00FFFF 00CCFF 993366 C0C0C0 FF99CC FFCC99 FFFF99 CCFFFF 99CCFF FFFFFF 15428B DFE8F6".split(" ")})(jQuery);util.namespace("jc2cui.mapWidget");
jc2cui.mapWidget.featureEditor=function(){function a(a){var b=$('<div id="marker-icons">').appendTo(a),c,d,e=function(c){return function(d){f.iconUrl=c;$("#characteristicsButton",a.parent()).attr("src",f.iconUrl);$(".marker-icon",b).removeClass("selected");$(this).addClass("selected")}};for(c=0;c<h.length;c++)d=[32*-(c%g),32*-Math.floor(c/g)],$('<a class="marker-icon" tabindex="1"></a>').css("background-position",d[0]+"px "+d[1]+"px").appendTo(b).click(e(h[c]))}function b(a){var b=$('<div><label>line color <input id="strokeColor" type="text"></label><label>line width (pixels) <input id="strokeWeight" type="text"></label><label>line opacity <input id="strokeOpacity" type="text"></label></div>').appendTo(a);
$("#strokeColor",b).colorPicker(f.strokeColor,function(b){f.strokeColor=b;$("#mask",a.parent()).css({"background-color":"line"===f.type?f.strokeColor:f.fillColor,"border-color":f.strokeColor})},e);$("#strokeWeight",b).val(f.strokeWeight).change(function(){var a=parseInt($(this).val(),10);isNaN(a)||(f.strokeWeight=a)});$("#strokeOpacity",b).val(Math.floor(100*f.strokeOpacity)).change(function(){var a=parseInt($(this).val(),10);isNaN(a)||(a=Math.max(0,Math.min(100,a))/100,f.strokeOpacity=a)})}function c(a){var b=
$('<div><label>fill color <input id="fillColor" type="text"></label><label>fill opacity <input id="fillOpacity" type="text"></label></div>').appendTo(a);$("#fillColor",b).colorPicker(f.fillColor,function(b){f.fillColor=b;$("#mask",a.parent()).css({"background-color":"line"===f.type?f.strokeColor:f.fillColor})},e);$("#fillOpacity",b).val(Math.floor(100*f.fillOpacity)).change(function(){var a=parseInt($(this).val(),10);isNaN(a)||(a=Math.max(0,Math.min(100,a))/100,f.fillOpacity=a)})}function d(d,e){var f=
$('<div id="characteristics""><div id="back">back</div></div>').appendTo(e);switch(d){case "marker":a(f);break;case "line":b(f);break;case "shape":b(f),c(f)}return f}var e,f,g=7,h=function(){var a=[],b=["-circle.png","-blank.png","-pushpin.png"],c="blu red grn ltblu ylw purple pink".split(" "),d="dining coffee bars snack_bar tram lodging wheel_chair_accessible shopping movies convenience grocery arts homegardenbusiness electronics mechanic partly_cloudy realestate salon dollar parking_lot gas_stations cabs bus truck rail airports ferry heliport subway info flag earthquake webcam post_office police firedept hospitals info_circle phone caution falling_rocks camera parks campfire picnic campground ranger_station toilets poi hiker cycling motorcycling horsebackriding play golf trail water snowflake_simple marina fishing sailing swimming ski woman man rainy volcano sunny euro yen".split(" "),
e,f,g;for(e=0;e<b.length;e++)for(f=0;f<c.length;f++)g=c[f],a.push([jc2cui.mapWidget.getAppPath(),"images/",g,b[e]].join(""));for(e=0;e<d.length;e++)a.push([jc2cui.mapWidget.getAppPath(),"images/",d[e],".png"].join(""));return a}();return{useShim:function(a){e=a},getEditFeatureHtml:function(a,b){f=a;var c=$(['<div class="editFeature"><div id="outer"><div id="basic"><div class="bold top">Title <input id="title" type="text" id="title" /><div id="mask"><img id="characteristicsButton" src="',f.iconUrl,
'" title="Click to set ',f.type,' characteristics"></div></div><div class="bold section">Description</div><textarea id="description"></textarea></div></div><div class="buttons"><span id="delete" class="button">delete</span><span id="cancel" class="button">cancel</span><span id="ok" class="button">ok</span></div></div>'].join("")),e,g;$("#title",c).val(f.title||"");$("#description",c).val(f.description||"");$("#characteristicsButton",c).click(function(){e||(e=$("#basic",c));g||(g=d(f.type,$("#outer",
c)));$("#back",g).click(function(){g.hide();e.show()});e.hide();g.show()});$("#mask",c).css({"background-color":"marker"===f.type?"transparent":"line"===f.type?f.strokeColor:f.fillColor,"border-color":"marker"===f.type?"transparent":f.strokeColor});$("#delete",c).click(function(){b&&b.deleted&&b.deleted()});$("#ok",c).click(function(){b&&b.updated&&(f.title=$("#title",c).val(),f.description=$("#description",c).val(),b.updated(f))});$("#cancel",c).click(function(){b&&b.canceled&&b.canceled()});return c[0]}}}();
util.namespace("jc2cui.mapWidget");
jc2cui.mapWidget.kmlParser=function(){function a(){if(void 0===Q){var a=document.createElement("x"),b=document.documentElement,c=window.getComputedStyle;void 0===a.style.pointerEvents?Q=!1:(a.style.pointerEvents="auto",a.style.pointerEvents="x",b.appendChild(a),c=c&&"auto"===c(a,"").pointerEvents,b.removeChild(a),Q=!!c)}return Q}function b(a,c,d,e){if(0===a&&void 0!==z)e(z);else if(1===a&&void 0!==O)e(O);else if(P)setTimeout(function(){b(a,c,d,e)},1E3);else{P=!0;"function"===typeof c&&(c=c());var f=
$("<div>"+c+'<br><br><div><input type="checkbox" id="global">Dont show again, apply to all overlays<br></div>'),g=$(window),h=g.innerHeight(),g=g.innerWidth();f.dialog({preferredHeight:220,preferredWidth:300,height:Math.min(220,h-20),width:Math.min(300,g-20),modal:!1,title:d,buttons:{Yes:function(){f.dialog("close");e(!0,$("#global",f).is(":checked"))},No:function(){f.dialog("close");e(!1,$("#global",f).is(":checked"))}},close:function(a,b){P=!1;f.remove()}})}}function c(b){var c=$(t.container),d=
$('<img class="screenOverlay" src='+b.href+">"),e,f=!1,g=this;this.visibility=b.visibility;this.visible=b.visible;this.name=b.name;this.placer=function(){return function(){var a={},h=0,k=0,l,m,p=d[0].height,H=d[0].width,G=b.overlayXY.x,n=b.overlayXY.y;b.screenXY&&(m=c.height(),l=c.width(),h=b.screenXY.x,k=b.screenXY.y,"insetPixels"===b.screenXY.xunits?h=l-h-H:"fraction"===b.screenXY.xunits&&(h*=l),"pixels"===b.screenXY.yunits?k=m-k:"fraction"===b.screenXY.yunits&&(k=m*(1-k)));b.sizeXY&&(0<b.sizeXY.x&&
("pixels"===b.sizeXY.xunits?H=b.sizeXY.x:"fraction"===b.sizeXY.xunits&&(l=l||c.width(),H=l*b.sizeXY.x)),0<b.sizeXY.y&&("pixels"===b.sizeXY.yunits?p=b.sizeXY.y:"fraction"===b.sizeXY.yunits&&(m=m||c.height(),p=m*b.sizeXY.y)),0===b.sizeXY.x&&0!==b.sizeXY.y&&(l=d[0].width/d[0].height,H=p*l),0===b.sizeXY.y&&0!==b.sizeXY.x&&(l=d[0].width/d[0].height,p=H/l),H&&(a.width=H),p&&(a.height=p));b.overlayXY&&("pixels"===b.overlayXY.xunits?G=-G:"insetPixels"===b.overlayXY.xunits?G=-(H-G):"fraction"===b.overlayXY.xunits&&
(G*=-H),"pixels"===b.overlayXY.yunits?n=-p+n:"insetPixels"===b.overlayXY.yunits?n=-n:"fraction"===b.overlayXY.yunits&&(n=-p*(1-n)),h+=G,k+=n);0!==h&&(a.left=h+"px");0!==k&&(a.top=k+"px");d.css(a);e&&e.css(a);b.rotation&&!f&&(f=!0,b.rotation=0>b.rotation?-b.rotation:360-b.rotation,d.rotate(b.rotation));g.visible||g.setVisible(!1);d.css("opacity",1)}}();d.css("opacity",0);d.load(this.placer);this.image=d.appendTo(c);a()||(e=$('<span class="screenOverlay"></span>'),e.css({"background-color":"#F5F5F5",
opacity:0.3,"z-index":0}),this.mask=e.appendTo(c));this.internalId="a"+(++ba).toString()}function d(a){this.internalId="a"+(++ba).toString();this.parent=a;this.features=[]}function e(a,b){b||++A;this.internalId="a"+(++ba).toString();this.containers=[];this.features=[];this.screenOverlays=[];this.viewSensitiveFeatures=[];this.visibility=!0;a&&(this.parent=a,a.containers.push(this),a.maintainState&&(this.maintainState=!0,this.idMap={},this.nameMap={}),this.loadMorePlacemarks=a.loadMorePlacemarks)}function f(a){return setTimeout(function(){a.features.length&&
a.features[0].refreshIcon(a)},a.icon.viewRefreshTime)}function g(){e.apply(this,arguments);this.intervals=[];this.loaded=!1}function h(a){var b="",c;if(a)if(2===a.nodeType||3===a.nodeType||4===a.nodeType)b=a.nodeValue;else if(1===a.nodeType||9===a.nodeType||11===a.nodeType)for(c=0;c<a.childNodes.length;++c)b+=h(a.childNodes[c]);return $.trim(b)}function k(a,b){if(a){var c=a.getElementsByTagName(b);if(c.length)return h(c[0])}}function l(a,b){var c=h(a);return c.length?0!==parseInt(c,10):b||!1}function m(a,
b,c){return a&&(a=a.getElementsByTagName(b),a.length)?l(a[0],c):c}function p(a){var b={},c,d,e;if(1===a.nodeType||9===a.nodeType||11===a.nodeType){if(0<a.attributes.length)for(d=0;d<a.attributes.length;d++)c=a.attributes.item(d),b[c.nodeName]=h(c)}else if(2===a.nodeType||3===a.nodeType||4===a.nodeType)b=h(a);if(a.hasChildNodes())if(1!==a.childNodes.length||2!==a.childNodes[0].nodeType&&3!==a.childNodes[0].nodeType&&4!==a.childNodes[0].nodeType)for(d=0;d<a.childNodes.length;d++)e=a.childNodes.item(d),
3!==e.nodeType&&8!==e.nodeType&&(c=e.nodeName,e=p(e),b[c]?($.isArray(b[c])||(b[c]=[b[c]]),b[c].push(e)):b[c]=e);else b=h(a.childNodes[0]);return b}function n(a){return{x:parseFloat(a.getAttribute("x")),y:parseFloat(a.getAttribute("y")),xunits:a.getAttribute("xunits"),yunits:a.getAttribute("yunits")}}function q(a){var b=parseFloat(k(a,"altitude")),c=k(a,"altitudeMode"),d=parseFloat(k(a,"range"));isNaN(d)?isNaN(b)&&(b=0):b=d;c&&c.length||(c="relativeToGround");return{latitude:parseFloat(k(a,"latitude")),
longitude:parseFloat(k(a,"longitude")),altitude:b,altitudeMode:c,range:d}}function r(a){if(a.childNodes.length)return a={latLonAltBox:{north:parseFloat(k(a,"north")),south:parseFloat(k(a,"south")),east:parseFloat(k(a,"east")),west:parseFloat(k(a,"west"))},lod:{minLodPixels:parseFloat(k(a,"minLodPixels")),maxLodPixels:parseFloat(k(a,"maxLodPixels"))||-1}},t.region?t.region(a):a}function v(a){a&&(this.href=k(a,"href"),this.refreshMode=k(a,"refreshMode"),this.viewRefreshMode=k(a,"viewRefreshMode"),this.viewFormat=
k(a,"viewFormat"),"onInterval"===this.refreshMode&&(this.interval=parseFloat(k(a,"refreshInterval"))),"onStop"===this.viewRefreshMode&&(this.viewRefreshTime=parseFloat(k(a,"viewRefreshTime")),isNaN(this.viewRefreshTime)&&(this.viewRefreshTime=4),this.viewRefreshTime*=1E3,this.viewFormat&&this.viewFormat.length||(this.viewFormat="BBOX=[bboxWest],[bboxSouth],[bboxEast],[bboxNorth]")))}function w(a,b){var c={},d,e,f,g;a=a||"ffffffff";d=a.substr(0,2);g=a.substr(2,2);f=a.substr(4,2);e=a.substr(6,2);c.opacity=
parseInt(d,16)/256;if("random"===b){d=[e,f,g];for(f=0;2>f;f++)g=Math.round(Math.random()*parseInt(e,16)).toString(16),1===g.length&&(g="0"+g),d[f]=g;e="#"+d[0]+d[1]+d[2]}else e="#"+e+f+g;c.color=e;return c}function x(a){var b={},c,d,e,f,g;d=a.getElementsByTagName("Style");for(c=0;c<d.length;c++)e=d[c],(f=e.getAttribute("id"))&&(b["#"+f]=p(e));d=a.getElementsByTagName("StyleMap");for(c=0;c<d.length;c++)if(e=d[c],f=e.getAttribute("id"))a=k(d[c],"key"),"normal"===a&&((a=k(d[c],"styleUrl"))?(e=a.indexOf("#"),
0<e?(g=a.substring(0,e),a=a.substring(e),M[g]&&(a=M[g][a])):(0>e&&(a="#"+a),a=b[a]),a?b["#"+f]=a:console.log("styleMap styleUrl of #"+f+" not found")):(a=d[c].getElementsByTagName("Style"),a.childNodes.length&&(b["#"+f]=p(a.childNodes[0]))));$.each(b,function(a,b){b.LineStyle&&b.LineStyle.color&&"string"===typeof b.LineStyle.color&&(b.LineStyle.color=w(b.LineStyle.color,b.LineStyle.colorMode));b.PolyStyle&&b.PolyStyle.color&&"string"===typeof b.PolyStyle.color&&(b.PolyStyle.color=w(b.PolyStyle.color,
b.PolyStyle.colorMode))});return b}function D(a){var b=[];a=a.getElementsByTagName("Schema");var c;for(c=0;c<a.length;c++)"Placemark"===a[c].getAttribute("parent")&&b.push(a[c].getAttribute("name"));return b}function C(a,b,c,d){return function(e){M[b]=e.doc?e.doc.styles:{};K(a,c+1,d)}}function K(a,b,c){for(var d=a.getElementsByTagName("styleUrl"),e,f,g;b<d.length;b++)if(e=h(d[b]),f=e.indexOf("#"),0<f&&0===e.indexOf("http")&&(e=e.substring(0,f),!M[e])){g=s(e,!1,null,C(a,e,b,c),null,null,!0);break}g||
c()}function V(a){var b,c=[],d;a=a.replace(/,\s+/g,",");a=a.split(/\s+/g);for(d=0;d<a.length;d++)b=a[d].split(","),1<b.length&&c.push({lon:parseFloat(b[0]),lat:parseFloat(b[1]),alt:parseFloat(b[2])});return c}function ha(a,b,c,e){var f=new d(b),g,l=[],E=[],F=[],u,B,n,H,G,aa;f.id=a.getAttribute("id");f.name=k(a,"name");f.description=k(a,"description");f.styleUrl=k(a,"styleUrl");g=a.getElementsByTagName("Style");g.length&&(f.style=p(g[0]),f.style.LineStyle&&f.style.LineStyle.color&&"string"===typeof f.style.LineStyle.color&&
(f.style.LineStyle.color=w(f.style.LineStyle.color,f.style.LineStyle.colorMode)),f.style.PolyStyle&&f.style.PolyStyle.color&&"string"===typeof f.style.PolyStyle.color&&(f.style.PolyStyle.color=w(f.style.PolyStyle.color,f.style.PolyStyle.colorMode)));f.styleUrl&&(g=f.styleUrl.indexOf("#"),0<g?(B=f.styleUrl.substring(0,g),g=f.styleUrl.substring(g),M[B]&&(g=M[B][g])):(0>g&&(f.styleUrl="#"+f.styleUrl),g=e.styles[f.styleUrl]),f.style=f.style?$.extend(!0,{},g,f.style):g);g=a.getElementsByTagName("Region");
g.length&&(f.region=r(g[0]));g=a.getElementsByTagName("Point");for(u=0;u<g.length;u++){if(e.removed)return;(n=k(g[u],"coordinates"))&&l.push(V(n))}g=a.getElementsByTagName("LineString");for(u=0;u<g.length;u++){if(e.removed)return;(n=k(g[u],"coordinates"))&&E.push(V(n))}g=a.getElementsByTagName("LinearRing");for(u=0;u<g.length;u++){if(e.removed)return;"outerBoundaryIs"!==g[u].parentNode.nodeName&&"innerBoundaryIs"!==g[u].parentNode.nodeName&&(n=k(g[u],"coordinates"))&&(n[n.length-1].lat===n[0].lat&&
n[n.length-1].lon===n[0].lon||n.push(n[0]),E.push(V(n)))}g=a.getElementsByTagName("Polygon");for(u=0;u<g.length;u++){if(e.removed)return;G=[];H=g[u].getElementsByTagName("outerBoundaryIs");n=k(H[0],"coordinates");G.push(V(n));H=g[u].getElementsByTagName("innerBoundaryIs");for(B=0;B<H.length;B++)n=k(H[B],"coordinates"),G.push(V(n));F.push(G)}B=a.getElementsByTagName("Camera");B.length?B=q(B[0]):(B=a.getElementsByTagName("LookAt"),B=B.length?q(B[0]):void 0);f.viewer=B;b&&(b.features.push(f),f.region&&
b.viewSensitiveFeatures.push(f),b.maintainState&&(f.id?(c&&(aa=c.idMap[f.id]),b.idMap[f.id]=f):f.name&&(c&&(aa=c.nameMap[f.name]),b.nameMap[f.name]=f)));g=a.getElementsByTagName("ExtendedData");if(g.length){c=g[0].getElementsByTagName("Data");g={};if(c.length)for(B=0;B<c.length;B++)u=c[B].getAttribute("name"),n=h(c[B].getElementsByTagName("value")[0]),g[u]=n;f.extendedData=g}aa&&(f.visibility=aa.visibility);void 0===f.visibility&&(f.visibility=m(a,"visibility",!0));f.visibility=f.visibility&&b.visibility;
f.visible=f.visibility&&(!f.region||t.isRegionActive&&t.isRegionActive(f.region));if(t.marker)for(B=0;B<l.length;B++){if(e.removed)return;(a=t.marker(f,l[B][0],e))&&f.features.push(a)}if(t.polyline)for(B=0;B<E.length;B++){if(e.removed)return;(a=t.polyline(f,E[B],e))&&f.features.push(a)}if(t.polygon)for(B=0;B<F.length;B++){if(e.removed)return;(a=t.polygon(f,F[B],e))&&($.isArray(a)?$.merge(f.features,a):f.features.push(a))}aa&&jc2cui.mapWidget.infoWindow&&jc2cui.mapWidget.infoWindow.getMapItem()&&jc2cui.mapWidget.infoWindow.getMapItem().internalId===
aa.internalId&&t.refreshInfoWindow&&t.refreshInfoWindow(f);A+=Math.max(1,f.features.length)}function Y(a,b,d,e){var f={name:k(a,"name"),id:a.getAttribute("id"),parent:b},g=a.getElementsByTagName("Icon"),l=a.getElementsByTagName("screenXY"),E=a.getElementsByTagName("overlayXY"),F=a.getElementsByTagName("size"),u=a.getElementsByTagName("rotation");l&&l.length&&(f.screenXY=n(l[0]));E&&E.length&&(f.overlayXY=n(E[0]));F&&F.length&&(f.sizeXY=n(F[0]));g&&g.length&&(f.href=k(g[0],"href"));u&&u.length&&(f.rotation=
parseFloat(h(u[0])));b&&b.maintainState&&(f.id?d&&d.idMap[f.id]&&(f.visibility=d.idMap[f.id].visibility):f.name&&(d&&d.nameMap[f.name])&&(f.visibility=d.nameMap[f.name].visibility));void 0===f.visibility&&(f.visibility=m(a,"visibility",!0));f.visible=f.visibility&&(!b||b.visibility);f=t.screenOverlay?t.screenOverlay(f,e):new c(f);++A;b&&(b.screenOverlays.push(f),b.maintainState&&(f.id?b.idMap[f.id]=f:f.name&&(b.nameMap[f.name]=f)))}function ja(a,b,c,e){var f=new d(b),g=k(a,"color"),h;f.latLonBox=
{north:parseFloat(k(a,"north")),east:parseFloat(k(a,"east")),south:parseFloat(k(a,"south")),west:parseFloat(k(a,"west"))};f.opacity=0.5;f.id=a.getAttribute("id");f.name=k(a,"name");h=a.getElementsByTagName("Icon");f.icon=h.length?new v(h[0]):new v;g&&(f.opacity=w(g).opacity);g=a.getElementsByTagName("Region");g.length&&(f.region=r(g[0]));b&&(b.features.push(f),(f.region||"onStop"===f.icon.viewRefreshMode||"onRequest"===f.icon.viewRefreshMode)&&b.viewSensitiveFeatures.push(f),b.maintainState&&(f.id?
(c&&c.idMap[f.id]&&(f.visibility=c.idMap[f.id].visibility),b.idMap[f.id]=f):f.name&&(c&&c.nameMap[f.name]&&(f.visibility=c.nameMap[f.name].visibility),b.nameMap[f.name]=f)));void 0===f.visibility&&(f.visibility=m(a,"visibility",!0));f.visible=f.visibility&&(!b||b.visibility)&&(!f.region||t.isRegionActive&&t.isRegionActive(f.region));t.groundOverlay&&f.features.push(t.groundOverlay(f,e));++A;return f}function fa(a,b,c,d){var e=new g(b),f=a.getElementsByTagName("Link"),h;f.length?e.link=new v(f[0]):
(f=a.getElementsByTagName("Url"),f.length&&(e.link=new v(f[0])));e.link||(e.link=new v);e.maintainState=!m(a,"refreshVisibility",!1);e.visibility=b.visibility&&m(a,"visibility",!0);e.visible=e.visibility&&b.visibility;e.open=m(a,"open",!1);e.id=a.getAttribute("id");e.name=k(a,"name");e.name&&e.name.length||(e.name=e.link.href);b.maintainState&&(c&&(h=c.containers[0]),h&&(e.visibility=h.visibility,e.open=h.open));f=a.getElementsByTagName("Region");f.length&&(e.region=r(f[0]));!e.region||t.isRegionActive&&
t.isRegionActive(e.region)?(++d.remaining,e.loaded=!0,e.loading=!0,e.loadedDoc=s(e.link.getHref(),e.visible,e,function(a){--d.remaining;!d.remaining&&d.initialParseCompleteCallback&&d.initialParseCompleteCallback({doc:d});a=e.loadedDoc||a.doc;e.loadLargeFile=a.loadLargeFile;e.loadMorePlacemarks=a.loadMorePlacemarks;e.loading=!1}),e.loadedDoc.visibility=e.visibility,"onInterval"===e.link.refreshMode&&e.link.interval&&e.intervals.push(setInterval(function(){if(!e.loading){e.loading=!0;var a=s(e.link.getHref(),
e.loadedDoc.visible,e,function(b){var c=a||b.doc;e.loading=!1;e.loadedDoc.remove();for(b=0;b<e.containers.length;b++)if(e.containers[b]===e.loadedDoc){e.containers.splice(b,1);e.loadedDoc=c;break}e.loadLargeFile=c.loadLargeFile;e.loadMorePlacemarks=c.loadMorePlacemarks},null,e.loadedDoc);a.visibility=e.loadedDoc.visibility}},1E3*e.link.interval))):e.visible=!1}function ga(a,b,c,d,e,f){return function(){S(a,b,c,d,e,f)}}function S(a,b,c,d,f,g){++y;if(ca)setTimeout(function(){--y;S(a,b,c,d,f,g)},10*
y);else{--y;ca=!0;var k,E,F,u,m,n,H,G;g=g||0;try{for(k=g;k<a.childNodes.length&&k<g+100;k++){if(d.removed){ca=!1;return}F=a.childNodes.item(k);u=F.nodeName;if("kml"===u){n=!0;S(F,b,c,d,f);break}if("Document"===u||"Folder"===u){m=new e(b);m.type=u;m.visible=b.visibility;m.visibility=b.visibility;m.id=F.getAttribute("id");if(b.maintainState){if("Document"===m.type)c&&(G=c.containers[0]);else if(m.id)c&&c.idMap[m.id]&&(G=c.idMap[m.id]),b.idMap[m.id]=m;else for(E=0;E<F.childNodes.length;E++)if(H=F.childNodes.item(E),
"name"===H.nodeName){m.name=h(H);c&&c.nameMap[m.name]&&(G=c.nameMap[m.name]);b.nameMap[m.name]=m;break}G&&(m.visibility=G.visibility,m.open=G.open)}n=!0;S(F,m,G,d,ga(a,b,c,d,f,k+1));break}if("NetworkLink"===u)fa(F,b,c,d);else if("Placemark"===u||-1<$.inArray(u,d.placemarkNames))ha(F,b,c,d);else if("ScreenOverlay"===u)Y(F,b,c,d);else if("GroundOverlay"===u)ja(F,b,c,d);else if("Region"===u){if(m=r(F,d))b.region=m,b.visible=b.visible&&b.visibility&&t.isRegionActive(b.region)}else if("visibility"===u)b.visibility=
b.visibility&&l(F,!0),b.visible=b.visible&&b.visibility&&(!b.region||t.isRegionActive(b.region));else if("name"===u)b.name=h(F);else if("open"===u)void 0===b.open&&(b.open=l(F,!1));else if("LookAt"===u||"Camera"===u)b.viewer=q(F),b.parent&&(b.parent.overlayId&&!b.parent.viewer)&&(b.parent.viewer=b.viewer)}}catch(p){console.log(p)}ca=!1;n||(k<a.childNodes.length?setTimeout(function(){S(a,b,c,d,f,k)},1):(f&&f({doc:d}),b===d&&(d.parseCompleteCallback&&d.parseCompleteCallback({doc:d}),t.parseCallback&&
t.parseCallback(d),--d.remaining,!d.remaining&&d.initialParseCompleteCallback&&d.initialParseCompleteCallback({doc:d}))))}}function T(a,c,d,e,f){c.fileSize&&(L+=c.fileSize);f&&(M[f]=M[f]||{});K(a,0,function(){c.styles=x(a);if(e)c.parseCompleteCallback({doc:c});else{c.placemarkNames=D(a);if(!c.loadMorePlacemarks&&!O){var f=0,g,h,k;h=c.placemarkNames.slice();h.push("Placemark");h.push("ScreenOverlay");h.push("GroundOverlay");h.push("NetworkLink");h.push("Document");h.push("Folder");for(g=0;g<h.length;g++)f+=
a.getElementsByTagName(h[g]).length;if(f+A>t.maxPlacemarks){g=[];for(h=c;h;)h.name&&h.name.length&&g.push(h.name),h=h.parent;g.reverse();k=g.join("/");b(1,function(){var a=["Overlay "];a.push(k);a.push(" contains approximately ");a.push(f);a.push(" entities. There are currently approximately ");a.push(A);a.push(" entities already loaded. ");a.push("Loading the additional entities may cause the browser to become unresponsive. Continue loading anyway?");return a.join("")},"Warning - Large Number Of Entities",
function(b,f){f&&(O=b);(c.loadMorePlacemarks=b)?S(a,c,d,c):(L-=c.fileSize,c.fileSize=0,--A,c.name=c.name||"",c.name+=" - LOAD CANCELED",c.parseCompleteCallback&&c.parseCompleteCallback({error:"canceled",doc:c}),!e&&t.parseCallback&&t.parseCallback(c))});return}}S(a,c,d,c)}})}function N(a){return 1048576>a?(a/1024).toFixed(2)+"kB":(a/1048576).toFixed(2)+"MB"}function s(a,c,d,f,g,h,k,E,l){var u;u=t.proxy.length?encodeURIComponent(a):a;var m=A,n;l=l||new e(d);l.remaining=1;l.parseCompleteCallback=f;
l.initialParseCompleteCallback=g;l.visibility=l.visible=c;l.clustering=E;h&&(l.open=h.open,l.loadLargeFile=l.loadLargeFile||h.loadLargeFile,l.loadMorePlacemarks=l.loadMorePlacemarks||h.loadMorePlacemarks);if(t.maxPlacemarks<m&&(!O&&!l.loadMorePlacemarks)&&(h&&(m-=h.getAllFeatures().length),t.maxPlacemarks<m)){if(void 0===l.loadMorePlacemarks){u=[];for(m=l;m;)m.name&&m.name.length&&u.push(m.name),m=m.parent;u.reverse();n=u.join("/");b(1,function(){var a=["There are currently approximately "];a.push(A);
a.push(" entities loaded. ");h?a.push("Reloading overlay "):a.push("Loading additional entities included in overlay ");a.push(n);a.push(" may cause the browser to become unresponsive. Continue loading anyway?");return a.join("")},"Warning - Large Number Of Entities",function(b,e){e&&(O=b);(l.loadMorePlacemarks=b)?s(a,c,d,f,g,h,k,E,l):(l.name=l.name||"",l.name+=" - LOAD CANCELED",f&&f({error:"canceled",doc:l}),!k&&t.parseCallback&&t.parseCallback(l))})}else l.parseCompleteCallback({error:"canceled",
doc:l}),!k&&t.parseCallback&&t.parseCallback(l);return l}if(U>=W)return++I,setTimeout(function(){--I;l.removed||s(a,c,d,f,g,h,k,E,l)},500+10*I),l;++U;u=$.ajax({dataType:"xml",url:t.proxy+u});u.done(function(c,d,e){var g,E,m,u;--U;if(!l.removed){l.fileSize=e.responseText.length;d=h?h.loadLargeFile:z;if(!d){m=L+e.responseText.length;if(h)for(E=[h],h.getAllContainers(E),u=0;u<E.length;u++)E[u].fileSize&&(m-=E[u].fileSize);if(m>1048576*t.maxFileSize){if(void 0===d){d=[];for(E=l;E;)E.name&&E.name.length&&
d.push(E.name),E=E.parent;d.reverse();g=d.join("/");b(0,function(){var a=["Overlay "];a.push(g);a.push(" is ");a.push(N(e.responseText.length));a.push(". After loading it, total loaded data will be ");a.push(N(m));a.push(". Loading so much data may cause the browser to become unresponsive. Load it anyway?");return a.join("")},"Warning - Large File Size",function(b,d){d&&(z=b);(l.loadLargeFile=b)?T(c,l,h,k,a):(l.fileSize=0,--A,l.name=l.name||"",l.name+=" - LOAD CANCELED",f&&f({error:"canceled",doc:l}),
!k&&t.parseCallback&&t.parseCallback(l))});return}if(!d){l.fileSize=0;--A;f&&f({error:"canceled",doc:l});!k&&t.parseCallback&&t.parseCallback(l);return}}}T(c,l,h,k,a)}});u.fail(function(b,c,d){--U;l.name=l.name||"";l.name+=" - LOAD FAILED";console.log("Failed to load "+a+" - "+c);f&&f({error:c,doc:l});!k&&t.parseCallback&&t.parseCallback(l)});return l}function X(a,b,c,d){var e,f,g,h;if((!a.name||!a.name.length)&&1>=a.containers.length&&!a.features.length&&!a.screenOverlays.length){e=[];for(f=0;f<
a.containers.length;f++)if(h=X(a.containers[0],b,c,d))if($.isArray(h))for(g=0;g<h.length;g++)e.push(h[g]);else e.push(h);return e}e={title:a.name||"[no name]",tooltip:"click to zoom to",key:a.parent?a.internalId:d,isFolder:!0,expand:a.open,select:a.visibility&&b,children:[]};a.parent||(e.isFeature=!0);for(f=0;f<a.containers.length;f++)if(h=X(a.containers[f],e.select,c))if($.isArray(h))for(g=0;g<h.length;g++)e.children.push(h[g]);else e.children.push(h);for(f=0;f<a.features.length;f++)b={title:a.features[f].name||
"[no name]",tooltip:"click to zoom to",key:a.features[f].internalId,select:a.features[f].visibility&&e.select},e.children.push(b);for(f=0;f<a.screenOverlays.length;f++)b={title:a.screenOverlays[f].name||"[no name]",tooltip:"click to zoom to",key:a.screenOverlays[f].internalId,select:a.screenOverlays[f].visibility&&e.select},e.children.push(b);return e}var J={proxy:"",maxFileSize:25,maxPlacemarks:75E3},t,M={},Q,W=5,U=0,I=0,ca,y=0,z,O,P,A=0,L=0,ba=0;c.prototype.remove=function(){this.image.remove();
this.mask&&this.mask.remove()};c.prototype.setVisible=function(a,b){var c;this.visible=a;if(b&&(this.visibility=a))for(c=this.parent;c&&!c.visibility;)c.visibility=!0,c=c.parent;a?(this.image.show(),this.mask&&this.mask.show()):(this.image.hide(),this.mask&&this.mask.hide())};c.prototype.extendBounds=function(a){};d.prototype.remove=function(){var a;this.removed=!0;for(a=0;a<this.features.length;a++)this.features[a].removeFromMap();jc2cui.mapWidget.infoWindow&&(jc2cui.mapWidget.infoWindow.getMapItem()&&
jc2cui.mapWidget.infoWindow.getMapItem().internalId===this.internalId)&&jc2cui.mapWidget.infoWindow.close();A-=Math.max(1,this.features.length)};d.prototype.setVisible=function(a,b){var c;this.visible=a;if(b&&(this.visibility=a))for(c=this.parent;c&&!c.visibility;)c.visibility=!0,c=c.parent;for(c=0;c<this.features.length;c++)this.features[c].setVisible(a);!a&&(jc2cui.mapWidget.infoWindow&&jc2cui.mapWidget.infoWindow.getMapItem()&&jc2cui.mapWidget.infoWindow.getMapItem().internalId===this.internalId)&&
jc2cui.mapWidget.infoWindow.close()};d.prototype.getBounds=function(){var a;t.bounds&&(a=t.bounds(),this.extendBounds(a));return a};d.prototype.extendBounds=function(a){var b;for(b=0;b<this.features.length;b++)this.features[b].extendBounds(a)};d.prototype.getAllVisiblePlacemarks=function(a){a=a||[];$.each(this.features,function(b,c){c.getVisible&&c.getVisible()&&a.push(c)});return a};e.prototype.getAllPlacemarks=function(a){var b;a=a||[];for(b=0;b<this.containers.length;b++)this.containers[b].getAllPlacemarks(a);
for(b=0;b<this.features.length;b++)$.merge(a,this.features[b].features);return a};e.prototype.getAllVisiblePlacemarks=function(a){var b;a=a||[];for(b=0;b<this.containers.length;b++)this.containers[b].getAllVisiblePlacemarks(a);for(b=0;b<this.features.length;b++)this.features[b].getAllVisiblePlacemarks(a);return a};e.prototype.remove=function(){var a;--A;this.removed=!0;this.fileSize&&(L-=this.fileSize);for(a=0;a<this.containers.length;a++)this.containers[a].remove();for(a=0;a<this.features.length;a++)this.features[a].remove();
for(a=0;a<this.screenOverlays.length;a++)this.screenOverlays[a].remove(),--A;t.containerRemoved&&t.containerRemoved(this)};e.prototype.setVisible=function(a,b){var c;this.visible=a;if(b&&(this.visibility=a))for(c=this.parent;c&&!c.visibility;)c.visibility=!0,c=c.parent;for(c=0;c<this.containers.length;c++)this.containers[c].setVisible(a,b);for(c=0;c<this.features.length;c++)this.features[c].setVisible(a,b);for(c=0;c<this.screenOverlays.length;c++)this.screenOverlays[c].setVisible(a,b)};e.prototype.extendBounds=
function(a){var b;for(b=0;b<this.containers.length;b++)this.containers[b].extendBounds(a);for(b=0;b<this.features.length;b++)this.features[b].extendBounds(a)};e.prototype.onViewUpdate=function(a){var b,c;this.region&&t.isRegionActive&&(c=t.isRegionActive(this.region),this.visibility&&c!==this.visible&&this.setVisible(c));for(b=0;b<this.containers.length;b++)this.containers[b].onViewUpdate(a);if(t.isRegionActive)for(b=0;b<this.viewSensitiveFeatures.length;b++)a=this.viewSensitiveFeatures[b],a.region&&
(c=t.isRegionActive(a.region),a.visibility&&c!==a.visible&&a.setVisible(c)),!a.icon||"onStop"!==a.icon.viewRefreshMode&&"onRequest"!==a.icon.viewRefreshMode||(clearTimeout(a.stopRefresh),a.stopRefresh=f(a))};e.prototype.getAllContainers=function(a){var b;a=a||[];for(b=0;b<this.containers.length;b++)this.containers[b].getAllContainers(a);$.merge(a,this.containers);return a};e.prototype.getAllFeatures=function(a){var b;a=a||[];for(b=0;b<this.containers.length;b++)this.containers[b].getAllFeatures(a);
$.merge(a,this.features);return a};e.prototype.getAllScreenOverlays=function(a){var b;a=a||[];for(b=0;b<this.containers.length;b++)this.containers[b].getAllScreenOverlays(a);$.merge(a,this.screenOverlays);return a};g.prototype=new e(null,!0);g.prototype.remove=function(){var a;e.prototype.remove.call(this);for(a=0;a<this.intervals.length;a++)clearInterval(this.intervals[a])};g.prototype.onViewUpdate=function(a){var b=this,c;if(!(this.link.viewRefreshMode&&"never"!==this.link.viewRefreshMode||this.region&&
!this.loaded)||"onRegion"===this.link.viewRefreshMode&&this.loaded)e.prototype.onViewUpdate.apply(this,arguments);else if(this.region&&t.isRegionActive&&("onRegion"===this.link.viewRefreshMode||!this.loaded))t.isRegionActive(this.region)&&(this.setVisible(this.visibility),this.loaded=!0,this.loadedDoc=s(this.link.getHref(),this.visible,this,function(a){a=a.doc||this.loadedDoc;b.loadLargeFile=a.loadLargeFile;b.loadMorePlacemarks=a.loadMorePlacemarks}),this.loadedDoc.visibility=this.visibility);else if("onStop"===
this.link.viewRefreshMode||"onRequest"===this.link.viewRefreshMode)clearTimeout(this.stopRefresh),b=this,c="onRequest"===this.link.viewRefreshMode?3E3:Math.max(0,this.link.viewRefreshTime-1E3),this.stopRefresh=setTimeout(function(){if(!this.region||t.isRegionActive&&t.isRegionActive(this.region)){var a=s(b.link.getHref(),b.loadedDoc.visible,b,function(c){var d=a||c.doc;b.loadedDoc.remove();for(c=0;c<b.containers.length;c++)if(b.containers[c]===b.loadedDoc){b.containers.splice(c,1);b.loadedDoc=d;break}b.loadLargeFile=
d.loadLargeFile;b.loadMorePlacemarks=d.loadMorePlacemarks},null,b.loadedDoc);a.visibility=b.loadedDoc.visibility}},c)};v.prototype.getHref=function(){var a=this.href||"";this.viewFormat&&(this.viewFormat.length&&t.formatView)&&(a=0>a.indexOf("?")?a+"?":a+"&",a+=t.formatView(this.viewFormat));return a};return{init:function(a){t=$.extend(!0,{},J,a)},loadKml:function(a,b,c,d,e,f,g,h){return s(a,b,c,function(a){!a.doc&&d&&d(a)},d,e,f,g,h)},parseKmlString:function(a,b,c,d,f){var g=new e(c),h;g.remaining=
1;g.parseCompleteCallback=function(a){!a.doc&&d&&d(a)};g.initialParseCompleteCallback=d;g.visibility=g.visible=b;g.clustering=f;setTimeout(function(){h=$.parseXML(a);T(h,g)},1);return g},Container:e,totalEntities:function(){return A},getEntitiesString:function(a){return"Approximately "+N(L)+" of data containing approximately "+(A+(a||0))+" entities loaded."},getTreeData:X}}();
OpenLayers.Strategy.AttributeCluster=OpenLayers.Class(OpenLayers.Strategy.Cluster,{attributes:null,rollups:null,copyAttributes:!0,layers:null,initialize:function(a){this.layers=[];return OpenLayers.Strategy.Cluster.prototype.initialize.apply(this,arguments)},destroy:function(){var a=this.layer,b=OpenLayers.Strategy.Cluster.prototype.destroy.apply(this,arguments);this.layers=null;a&&(a.map.removeLayer(a),a.destroy());return b},registerForLayerEvents:function(a){a.events.on({beforefeaturesadded:this.cacheFeatures,
moveend:this.cluster,removed:this.removeALayer,scope:this})},activate:function(){var a=OpenLayers.Strategy.prototype.activate.apply(this,arguments),b;if(a)for(b=0;b<this.layers.length;b++)this.registerForLayerEvents(this.layers[b]);return a},deactivate:function(){var a=OpenLayers.Strategy.prototype.deactivate.apply(this,arguments),b=this.layer;if(a)for(b&&b.removeAllFeatures(),this.clearCache(),b=0;b<this.layers.length;b++)this.layers[b].events.un({beforefeaturesadded:this.cacheFeatures,moveend:this.cluster,
scope:this});return a},cacheFeatures:function(a){var b=!0;if(!this.clustering){null===this.features&&(this.features=[]);for(b=0;b<a.features.length;b++)a.features[b].unclusteredLayer=a.object;this.features=this.features.concat(a.features);this.cluster();b=!1}return b},clearCache:function(){this.clustering||(this.features=null)},shouldCluster:function(a,b){var c=this.attributes,d,e,f;if(c&&c.length)for(f=0;f<c.length;f++)if(d=c[f],e=(e=a.cluster[0].attributes[d])&&void 0!==e.value?e.value:e,d=(d=b.attributes.extendedData[d])&&
void 0!==d.value?d.value:d,e!==d)return!1;return OpenLayers.Strategy.Cluster.prototype.shouldCluster.apply(this,arguments)},getFeatureVisibility:function(a){return a.style&&"none"===a.style.display?!1:!0},createCluster:function(a){var b=OpenLayers.Strategy.Cluster.prototype.createCluster.apply(this,arguments);b.attributes.count=this.getFeatureVisibility(a)?1:0;this.initRollup(b,a);this.tallyRollup(b,a);return b},addToCluster:function(a,b){var c=a.attributes.count;OpenLayers.Strategy.Cluster.prototype.addToCluster.apply(this,
arguments);!this.getFeatureVisibility(b)&&a.attributes.count>c&&(a.attributes.count-=1);this.tallyRollup(a,b)},initRollup:function(a,b){var c=this.rollups,d,e,f,g;if(this.copyAttributes&&this.attributes&&this.attributes.length)for(f=0;f<this.attributes.length;f++)e=this.attributes[f],d=(d=b.attributes[e])&&void 0!==d.value?d.value:d,a.attributes[e]=d;if(c&&c.length)for(f=0;f<c.length;f++)if(d=c[f],e=a.attributes[d.attribute]={},(d=d.values)&&d.length)for(g=0;g<d.length;g++)e[d[g]]=0},tallyRollup:function(a,
b){var c=this.rollups,d,e,f;if(c&&c.length)for(f=0;f<c.length;f++)d=c[f].attribute,e=void 0===b.attributes.extendedData[d]?"_other_":b.attributes.extendedData[d],(e=void 0===e.value?e:e.value)&&e.length||(e="_other_"),d=a.attributes[d],d[e]=void 0===d[e]?1:d[e]+1},cluster:function(a,b){if((!a||a.zoomChanged)&&this.features){var c=this.layer.map.getResolution(),d,e,f,g,h;if(!a||c!==this.resolution||!this.clustersExist()||b){this.resolution=c;c=[];for(g=0;g<this.features.length;++g)if(d=this.features[g],
d.geometry){e=!1;for(h=c.length-1;0<=h;--h)if(f=c[h],this.shouldCluster(f,d)){this.addToCluster(f,d);e=!0;break}e||c.push(this.createCluster(this.features[g]))}for(g=0;g<this.layers.length;g++)this.layers[g].removeAllFeatures();this.layer.removeAllFeatures();if(0<c.length){if(1<this.threshold)for(d=c.slice(),c=[],g=0,h=d.length;g<h;++g)e=d[g],0<e.attributes.count&&(e.attributes.count<this.threshold?Array.prototype.push.apply(c,e.cluster):c.push(e));this.clustering=!0;this.layer.addFeatures(c);this.clustering=
!1}this.clusters=c}}},addLayer:function(a){this.layers.push(a);this.active&&this.registerForLayerEvents(a)},removeALayer:function(a){if(this.layer){a=a.layer;var b=$.inArray(a,this.layers),c;if(-1!==b){this.layers.splice(b,1);if(this.features)for(b=this.features,this.features=[],c=0;c<b.length;c++)b[c].unclusteredLayer!==a&&this.features.push(b[c]);this.cluster(null,!0)}}},removeLayer:function(a){this.removeALayer({layer:a})},CLASS_NAME:"OpenLayers.Strategy.AttributeCluster"});var OWF,callback;util.namespace("jc2cui.mapWidget");
jc2cui.mapWidget.renderer=function(){function a(a,b,c,d){this.id=a;this.name=b||a;this.clustering=d;this.children={};this.docs={};c?(this.parent=c,c.children[this.id]=this,this.visible=c.visible):this.visible=!0;z[this.id]=this}function b(a){var b=[],c=[a];a.getAllContainers(c);$.each(c,function(a,c){c.layer&&b.push(c.layer);c.strategy&&c.strategy.layer&&b.push(c.strategy.layer)});return b}function c(a,b){"transparent"===a&&(a="#ffffff",b=0);var c=a.replace(/#?([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})/i,
"ff$3$2$1").toLowerCase(),d;void 0!==b&&(d=Math.floor(255*b).toString(16),2>d.length&&(d="0"+d),c=d+c.substring(2));return c}function d(a){var b=a.attributes,d=[];d.push('<kml xmlns="http://www.opengis.net/kml/2.2" xmlns:gx="http://www.google.com/kml/ext/2.2" xmlns:kml="http://www.opengis.net/kml/2.2" xmlns:atom="http://www.w3.org/2005/Atom"><Placemark id="');d.push(b.id);d.push('">');if(b.title||b.name)d.push("<name>"),d.push(b.title||b.name),d.push("</name>");b.description&&(d.push("<description><![CDATA["),
d.push(b.description),d.push("]]\x3e</description>"));d.push("<Style>");switch(b.type){case "marker":d.push("<IconStyle><Icon><href>");d.push(b.iconUrl);d.push('</href></Icon><hotSpot x="0.5" y="0" xunits="fraction" yunits="fraction"></hotSpot></IconStyle></Style>');break;case "line":case "shape":d.push("<LineStyle><color>"),d.push(c(b.strokeColor,b.strokeOpacity)),d.push("</color><width>"),d.push(b.strokeWeight),d.push("</width></LineStyle>"),"shape"===b.type&&(d.push("<PolyStyle><color>"),d.push(c(b.fillColor,
b.fillOpacity)),d.push("</color></PolyStyle>")),d.push("</Style>")}Z||(Z=new OpenLayers.Format.KML({internalProjection:s.baseLayer.projection}));a=Z.buildGeometryNode(a.geometry);d.push(OpenLayers.Format.XML.prototype.write.apply(Z,[a]));d.push("</Placemark></kml>");return d.join("")}function e(a){jc2cui.mapWidget.showUserDrawnEditWindow(a.attributes,{deleted:function(){jc2cui.mapWidget.deleteDrawing(a.fid)},updated:function(b){y&&y.redraw();b=d(a);jc2cui.mapWidget.publishDrawing(b,a.fid,a.attributes.title||
a.attributes.name,z[jc2cui.mapWidget.USER_DRAWN_OVERLAY].visible)}})}function f(a){a=Math.round(Math.log(352E5/a)/Math.log(2));if(0>a)a=0;else if(a>=s.getNumZoomLevels()||Infinity===a)a=s.getNumZoomLevels()-1;s.zoomTo(a)}function g(a,b){void 0!==b&&null!==b&&f("auto"===b?0:b);s.panTo(a)}function h(a,b){a&&(null!==a.left&&null!==a.top&&null!==a.right&&null!==a.bottom)&&("auto"===b?s.zoomToExtent(a):g(a.getCenterLonLat(),b))}function k(a){var b,c,d=[];a.cluster?(b=new OpenLayers.Bounds,$.each(a.cluster,
function(a,c){b.extend(c.geometry.getBounds());c.style&&"none"===c.style.display||d.push(c)}),a=a.layer.styleMap.createSymbolizer(a),a={name:a.title||"",description:a.description||"",placemarks:d,attributes:"attributes",bounds:b},jc2cui.mapWidget.showClusterInfoWindow(a)):(c={selectedId:a.attributes.id||a.fid||a.id||void 0,selectedName:a.attributes.title||a.attributes.name||void 0},a.unclusteredLayer?(c.featureId=a.unclusteredLayer.featureId,c.overlayId=a.unclusteredLayer.overlayId):a.layer&&(c.featureId=
a.layer.featureId,c.overlayId=a.layer.overlayId),jc2cui.mapWidget.showPlacemarkInfoWindow(a.attributes),jc2cui.mapWidget.itemSelected(c))}function l(){clearTimeout(ba);ba=setTimeout(function(){A&&(A.unselectAll(),A.deactivate(),s.removeControl(A),A.destroy(),A=null);if(!I){var a=[];$.each(z,function(b,c){$.merge(a,c.getLayers())});R&&(R.strategy&&R.strategy.layer)&&a.push(R.strategy.layer);0<a.length&&(A=new OpenLayers.Control.SelectFeature(a,{onSelect:function(a){k(a);A.unselectAll()}}),s.addControl(A),
A.activate())}},200)}function m(b){b?(A&&A.deactivate(),y||(b=OpenLayers.Util.applyDefaults({externalGraphic:"${iconUrl}",graphicWidth:32,graphicHeight:32,graphicXOffset:-16,graphicYOffset:-32,graphicOpacity:1,graphicTitle:"${title}",fillColor:"${fillColor}",fillOpacity:"${fillOpacity}",strokeColor:"${strokeColor}",strokeWidth:"${strokeWeight}",strokeOpacity:"${strokeOpacity}"},OpenLayers.Feature.Vector.style["default"]),b=new OpenLayers.StyleMap({"default":b}),y=new OpenLayers.Layer.Vector(jc2cui.mapWidget.USER_DRAWN_OVERLAY,
{styleMap:b,displayInLayerSwitcher:!1}),y.overlayId=jc2cui.mapWidget.USER_DRAWN_OVERLAY,y.events.on({beforefeatureadded:function(a){var b=a.feature.geometry.CLASS_NAME,b=b.substring(b.lastIndexOf(".")+1).toLowerCase();a.feature.attributes.title=L[b].name+" "+ ++L[b].numberDrawn;a.feature.fid=a.feature.id=a.feature.attributes.id=jc2cui.mapWidget.getNewId();a.feature.attributes.type=L[b].name;switch(b){case "point":a.feature.attributes.iconUrl=jc2cui.mapWidget.getDefaultDrawingIcon();break;case "linestring":case "polygon":a.feature.attributes.iconUrl=
[jc2cui.mapWidget.getAppPath(),"images/","polygon"===b?"poly":"line",'Mask.png"'].join(""),a.feature.attributes.strokeColor="#15428B",a.feature.attributes.strokeWeight=3,a.feature.attributes.strokeOpacity=0.8,"polygon"===b&&(a.feature.attributes.fillColor="#DFE8F6",a.feature.attributes.fillOpacity=0.5)}},featureadded:function(b){var c=d(b.feature),f=z[jc2cui.mapWidget.USER_DRAWN_OVERLAY],g;f||(f=new a(jc2cui.mapWidget.USER_DRAWN_OVERLAY));g=f.docs[jc2cui.mapWidget.USER_DRAWN_OVERLAY];g||(g=f.docs[jc2cui.mapWidget.USER_DRAWN_OVERLAY]=
new jc2cui.mapWidget.kmlParser.Container,g.layer=y);jc2cui.mapWidget.publishDrawing(c,b.feature.fid,b.feature.attributes.title||b.feature.attributes.name,z[jc2cui.mapWidget.USER_DRAWN_OVERLAY].visible);e(b.feature)},afterfeaturemodified:function(a){var b=d(a.feature);jc2cui.mapWidget.publishDrawing(b,a.feature.fid,a.feature.attributes.title||a.feature.attributes.name,z[jc2cui.mapWidget.USER_DRAWN_OVERLAY].visible)},removed:function(){var a=jc2cui.mapWidget.infoWindow.getMapItem(),b;if(a)for(b=0;b<
y.features.length;b++)a.id===y.features[b].attributes.id&&jc2cui.mapWidget.infoWindow.close();I?(m(!1),y=null,m(!0)):y=null}}),s.addLayer(y)),I=new OpenLayers.Control.EditingToolbar(y),b=new OpenLayers.Control.ModifyFeature(y,{displayClass:"olControlModifyFeature"}),$.extend(b.virtualStyle,{externalGraphic:null,fillColor:"#ee9900",fillOpacity:0.3,strokeColor:"#ee9900",strokeWidth:1,strokeOpacity:0.3}),I.addControls(b),I.addControls(new OpenLayers.Control.SelectFeature(y,{displayClass:"olControlSelectFeature",
onSelect:function(a){e(a);jc2cui.mapWidget.itemSelected({selectedId:a.attributes.id||a.fid||a.id||void 0,selectedName:a.attributes.title||a.attributes.name||void 0,featureId:a.layer.featureId||a.attributes.id||a.fid||a.id,overlayId:a.layer.overlayId});this.unselectAll()}})),s.addControl(I),$.each($("div",$(".olControlEditingToolbar")),function(a,b){$(b).attr("title",ca[a])})):(I.deactivate(),$.each(I.controls,function(a,b){s.removeControl(b)}),s.removeControl(I),I.destroy(),I=null,l())}function p(a){if(a&&
a.type){var b=OpenLayers.Layer[a.type],c;if(b)return c=new b(a.params[0],a.params[1],a.params[2],a.params[3],a.params[4]),c.isBaseLayer||((b=s.baseLayer.projection)&&b.equals(t)&&(b=M),c.projection=b,c.addOptions({projection:b})),c?(s.addLayer(c),c.isBaseLayer&&c.events.register("visibilitychanged",null,function(a){c.getVisibility()?(c.wmsDoc&&(c.wmsDoc.visible||(jc2cui.mapWidget.sidebar?jc2cui.mapWidget.sidebar.showFeature(c.wmsDoc.featureId,c.wmsDoc.overlayId,!0):c.wmsDoc.setVisible(!0,!0))),c.projection.equals(W.projection)||
(Z&&(Z.internalProjection=c.projection),$.each(s.getLayersByClass("OpenLayers.Layer.Vector"),function(a,b){b.projection=c.projection;$.each(b.features,function(a,c){c.geometry.transform(W.projection,b.projection);c.cluster&&$.each(c.cluster,function(a,c){c.geometry.transform(W.projection,b.projection)})});b.redraw()}),$.each(s.getLayersByClass("OpenLayers.Layer.Image"),function(a,b){b.projection=c.projection;b.extent.transform(W.projection,b.projection);b.redraw()}),$.each(s.getLayersByClass("OpenLayers.Layer.WMS"),
function(a,b){if(!b.isBaseLayer){var d=c.projection;d.equals(t)&&(d=M);b.projection=d;b.addOptions({projection:d});b.redraw()}}),setTimeout(function(){J.call(U,!0);s.setCenter(U,s.getZoom(),!1,!0);s.getZoom()>=s.getNumZoomLevels()&&s.zoomTo(s.getNumZoomLevels()-1)},1))):(W=c,U=P.clone(),c.wmsDoc&&c.wmsDoc.visible&&(jc2cui.mapWidget.sidebar?jc2cui.mapWidget.sidebar.hideFeature(c.wmsDoc.featureId,c.wmsDoc.overlayId,!0):c.wmsDoc.setVisible(!1,!0)))})):jc2cui.mapWidget.showError("Error",a.type+" layer failed to load succesfully."),
c;jc2cui.mapWidget.showError("Error",a.type+" map type not supported.")}else jc2cui.mapWidget.showError("Error","Bad layer configuration data.")}function n(a){if(a.script&&2!==N[a.type]){if(1===N[a.type]||void 0===N[a.type]&&a.callback&&callback)return setTimeout(function(){n(a)},1E3),!0;N[a.type]=1;a.callback&&(callback=function(){callback=null;N[a.type]=2;p(a)});$.ajax({url:a.script,dataType:"script",timeout:2E4,success:function(b,c){a.callback||(N[a.type]=2,p(a))},error:function(b,c,d){N[a.type]=
3;b="Error loading "+a.type+" script "+a.script;c&&"error"!==c&&(b+=": "+c);jc2cui.mapWidget.showError(b)}})}else p(a)}function q(){var a=s.getExtent(),b=s.getZoom(),b=352E5/Math.pow(2,b);J.call(a);P=a.getCenterLonLat();return jc2cui.mapWidget.createViewStatus(a.bottom,a.left,a.top,a.right,P.lat,P.lon,b)}function r(a){var b,c="";OpenLayers.ImgPath="openLayers-2.12/img/";OpenLayers.IMAGE_RELOAD_ATTEMPTS=3;OpenLayers.Util.onImageLoadErrorColor="transparent";s=new OpenLayers.Map("map",a.mapOptions);
$.each(a.layers,function(a,b){n(b)});X=s.baseLayer;s.addControl(new OpenLayers.Control.LayerSwitcher);s.addControl(new OpenLayers.Control.ScaleLine);a=new OpenLayers.Control.MousePosition({displayProjection:Q});a.formatOutput=function(a){return a.lat.toFixed(4)+", "+a.lon.toFixed(4)};s.addControl(a);s.events.register("moveend",null,function(){clearTimeout(b);b=setTimeout(function(){jc2cui.mapWidget.publishView(q());$.each(z,function(a,b){$.each(b.docs,function(a,b){b.onViewUpdate()})})},1E3)});s.events.register("mousemove",
null,function(a){O=a.xy});$("div:first",$(s.getViewport())).mousedown(function(a){da={x:a.pageX,y:a.pageY}}).mouseup(function(a){if(!da||2>Math.abs(a.pageX-da.x)&&2>Math.abs(a.pageY-da.y)){var b=(new Date).getTime(),c=1,d=s.getLonLatFromPixel(O);ka===a.which&&500>b-ia?(c=2,ia=1E3):ia=b;ka=a.which;J.call(d);jc2cui.mapWidget.mapClicked(d.lat,d.lon,c,a.which,a.shiftKey,a.ctrlKey,a.altKey)}da=null});jc2cui.mapWidget.infoWindow.init({containment:"#map",zIndex:1E3});c=document.location.href;c=c.substring(0,
c.lastIndexOf("/")+1);$('<link rel="stylesheet" type="text/css" href="'+(c+"css/openLayers.all.min.css")+'" >').appendTo("head");P=new OpenLayers.LonLat(-98.3,39.5);a=P.clone();J.call(a,!0);s.setCenter(a,3);jc2cui.mapWidget.rendererReady()}function v(a,b){var c=[b],d;b.getAllContainers(c);$.each(c,function(b,c){if(c.name===a)return d=c,!1});d||(c=b.getAllFeatures(),$.each(c,function(b,c){if(c.name===a)return d=c,!1}));d||(c=b.getAllScreenOverlays(),$.each(c,function(b,c){if(c.name===a)return d=c,
!1}));return d}function w(a,b,c){var d=[b],e;b.getAllContainers(d);$.each(d,function(b,d){if(!c&&d.internalId===a||c&&d.id===a)return e=d,!1});e||(d=b.getAllFeatures(),$.each(d,function(b,d){if(!c&&d.internalId===a||c&&d.id===a)return e=d,!1}));e||(b=b.getAllScreenOverlays(),$.each(b,function(b,d){if(!c&&d.internalId===a||c&&d.id===a)return e=d,!1}));return e}function x(a,b){jc2cui.mapWidget.kmlParser.Container.call(this);this.wmsLayer=a;if(this.background=b)this.wmsLayer.wmsDoc=this}function D(a,
b){var c;a.viewer?(c=new OpenLayers.LonLat(a.viewer.longitude,a.viewer.latitude),J.call(c,!0),g(c,"auto"===b?a.viewer.altitude:b)):(c=new OpenLayers.Bounds,a.extendBounds(c),h(c,b))}function C(a){if(jc2cui.mapWidget.options().clustering&&jc2cui.mapWidget.options().clustering.value)return a.clustering?a:a.parent?C(a.parent):a.overlayId&&(a=z[a.overlayId])?C(a):R}function K(b,c,d,e,f,g,h,k){h=z[b]||new a(b);var l,m=h.docs[c];l=jc2cui.mapWidget.kmlParser.loadKml(e,m?m.visible:h.visible,null,function(a){m&&
m.remove();a.error||f&&D(l,"auto")},null,null,g);l.featureId=c;l.overlayId=b;l.name=d;h.docs[c]=l}function V(b,c,d,e,f,g,h,k){h=z[b]||new a(b);var l,m=h.docs[c];l=jc2cui.mapWidget.kmlParser.parseKmlString(e,!0,null,function(a){m&&m.remove();a.error||f&&D(l,"auto")},g);l.featureId=c;l.overlayId=b;l.name=d;h.docs[c]=l}function ha(a,b){var c=z[b],d;c&&(a&&a.length)&&$.each(c.docs,function(b,c){d=v(a,c);return!d});return d}function Y(a,b,c){b=z[b];var d;b&&$.each(b.docs,function(b,e){d=w(a,e,c);return!d});
return d}function ja(a,b,c){a=z[a];var d=!1;a&&$.each(a.docs,function(a,e){var f=e.getAllContainers();$.each(f,function(a,e){if(e.internalId===b)return e.open=c,d=!0,!1});return!d})}function fa(a){var b=C(a);a.layer=new OpenLayers.Layer.Vector(a.name,{displayInLayerSwitcher:!1});if(b){if(!b.strategy){var c=$.extend(!0,{},la,b.clustering||{}),d=new OpenLayers.Strategy.AttributeCluster({distance:c.distance,threshold:c.threshold,attributes:c.attributes,rollups:c.rollups}),c=OpenLayers.Util.applyDefaults(c.style,
OpenLayers.Feature.Vector.style["default"]),e=new OpenLayers.Layer.Vector(b.name||"clusterer strategy",{displayInLayerSwitcher:!1});c.graphicTitle=c.title;e.styleMap=new OpenLayers.StyleMap({"default":c,select:{}});d.setLayer(e);s.addLayer(d.layer);b.strategy=d}b.strategy.addLayer(a.layer);a.layer.strategies=[b.strategy]}for(b=a;b.parent;)b=b.parent;a.layer.overlayId=b.overlayId;a.layer.featureId=b.featureId;s.addLayer(a.layer)}function ga(a){A&&(A.unselectAll(),A.deactivate(),s.removeControl(A),
A.destroy(),A=null);s.removeLayer(a);a.destroy();l()}function S(a){$.each(s.getLayersByClass("OpenLayers.Layer.Vector"),function(b,c){$.each(c.features,function(b,c){c.cluster?$.each(c.cluster,function(b,c){c.attributes&&c.attributes.name&&(c.style.label=a?c.attributes.name:void 0)}):c.attributes&&c.attributes.name&&(c.style.label=a?c.attributes.name:void 0)});c.redraw()})}function T(a){$.each(z,function(b,c){$.each(c.docs,function(b,c){var d=[c];c.getAllContainers(d);$.each(d,function(b,c){if(c.layer){var d=
[],e;c.layer.removeAllFeatures();c.clustering||delete c.layer.strategies;ga(c.layer);fa(c);c.getAllPlacemarks(d);if(!a)for(e=0;e<d.length;e++)delete d[e].unclusteredLayer;c.layer.addFeatures(d);l()}});!a&&c.strategy&&(c.strategy.destroy(),c.strategy=null)});!a&&c.strategy&&(c.strategy.destroy(),c.strategy=null)});!a&&(R&&R.strategy)&&(R.strategy.destroy(),R.strategy=null)}var N={},s,X,J,t=new OpenLayers.Projection("EPSG:900913"),M=new OpenLayers.Projection("EPSG:3857"),Q=new OpenLayers.Projection("EPSG:4326"),
W,U,I,ca="Zoom/pan map;Add a placemark;Add a line;Add a shape;Edit points;Edit attributes".split(";"),y,z={},O,P,A=null,L={point:{name:"marker",numberDrawn:0},linestring:{name:"line",numberDrawn:0},polygon:{name:"shape",numberDrawn:0}},ba,Z,R={clustering:{}},la={style:{fillColor:"red",strokeColor:"black",pointRadius:10,label:"${count}",title:"${count} Items"},distance:50,threshold:2,attributes:[],rollups:[]},da,ka=-1,ia=1E3,ea;a.prototype.setVisibility=function(a){var b=a?void 0:jc2cui.mapWidget.infoWindow.getMapItem();
this.visible=a;$.each(this.docs,function(c,d){d.setVisible(a,!0);if(y&&d.layer===y&&(y.setVisibility(a),b)){var e;for(e=0;e<y.features.length;e++)b.id===y.features[e].attributes.id&&jc2cui.mapWidget.infoWindow.close()}});$.each(this.children,function(b,c){c.setVisibility(a)})};a.prototype.remove=function(){delete z[this.id];this.parent&&delete this.parent.children[this.id];$.each(this.docs,function(a,b){b.remove()});$.each(this.children,function(a,b){b.remove()})};a.prototype.bounds=function(){var a=
new OpenLayers.Bounds;$.each(this.docs,function(b,c){c.extendBounds(a);if(y&&c.layer===y){var d=y.getDataExtent();d&&(null!==d.left&&null!==d.top&&null!==d.right&&null!==d.bottom)&&(null!==a.left&&null!==a.top&&null!==a.right&&null!==a.bottom?a.extend(d):a=d)}});$.each(this.children,function(b,c){var d=c.bounds();d&&(null!==d.left&&null!==d.top&&null!==d.right&&null!==d.bottom)&&(null!==a.left&&null!==a.top&&null!==a.right&&null!==a.bottom?a.extend(d):a=d)});return a};a.prototype.getLayers=function(){var a=
[];$.each(this.docs,function(c,d){$.merge(a,b(d))});$.each(this.children,function(b,c){$.merge(a,c.getLayers())});this.strategy&&this.strategy.layer&&a.push(this.strategy.layer);return a};J=function(a){Q.equals(s.baseLayer.projection)||this.transform(a?Q:s.baseLayer.projection,a?s.baseLayer.projection:Q)};x.prototype=new jc2cui.mapWidget.kmlParser.Container(null,!0);x.prototype.remove=function(){s.baseLayer===this.wmsLayer&&s.setBaseLayer(X);s.removeLayer(this.wmsLayer)};x.prototype.setVisible=function(a,
b){this.visible=a;b&&(this.visibility=a);if(this.background)if(a)s.setBaseLayer(this.wmsLayer);else{if(s.baseLayer===this.wmsLayer){var c=this.wmsLayer;setTimeout(function(){s.baseLayer===c&&s.setBaseLayer(X)},100)}}else this.wmsLayer.setVisibility(a)};return{init:function(a){function b(a){var c=a.style||{},d={},e=32,f=32,g=1;c.LineStyle&&(c.LineStyle.color&&(d.strokeColor=c.LineStyle.color.color,d.strokeOpacity=c.LineStyle.color.opacity),d.strokeWidth=c.LineStyle.width);c.PolyStyle&&(c.PolyStyle.color&&
(d.fillColor=c.PolyStyle.color.color,d.fillOpacity=c.PolyStyle.color.opacity),"0"===c.PolyStyle.fill&&(d.fillOpacity=0),"0"===c.PolyStyle.outline&&(d.strokeWidth=0));c.IconStyle&&(g=void 0!==c.IconStyle.scale?c.IconStyle.scale:1,c.IconStyle.Icon&&(c.IconStyle.Icon.href&&0<=c.IconStyle.Icon.href.indexOf("http://maps.google.com/mapfiles/kml"))&&(f=e=64,g/=2),e*=g,f*=g,d.graphicOpacity=1,c.IconStyle.Icon&&(d.externalGraphic=c.IconStyle.Icon.href),c.IconStyle.hotSpot&&("pixels"===c.IconStyle.hotSpot.xunits?
d.graphicXOffset=-c.IconStyle.hotSpot.x*g:"insetPixels"===c.IconStyle.hotSpot.xunits?d.graphicXOffset=-e+c.IconStyle.hotSpot.x*g:"fraction"===c.IconStyle.hotSpot.xunits&&(d.graphicXOffset=-e*c.IconStyle.hotSpot.x),"pixels"===c.IconStyle.hotSpot.yunits?d.graphicYOffset=-f+c.IconStyle.hotSpot.y*g+1:"insetPixels"===c.IconStyle.hotSpot.yunits?d.graphicYOffset=-(c.IconStyle.hotSpot.y*g)+1:"fraction"===c.IconStyle.hotSpot.yunits&&(d.graphicYOffset=-f*(1-c.IconStyle.hotSpot.y)+1)),d.graphicWidth=e,d.graphicHeight=
f,d.rotation=c.IconStyle.heading);a.name&&(d.label=jc2cui.mapWidget.options().labels&&jc2cui.mapWidget.options().labels.value?a.name:void 0,d.fontColor=d.fontColor||"blue",d.fontSize=d.fontSize||"12px",d.fontFamily=d.fontFamily||"Courier New, monospace",d.fontWeight=d.fontWeight||"bold",d.labelAlign=d.labelAlign||"cb",d.labelYOffset=d.labelYOffset||-20,d.labelOutlineColor=d.labelOutlineColor||"white",d.labelOutlineWidth=d.labelOutlineWidth||3);return d}function c(a){var b=[],d;for(d=0;d<a.length;d++)b.push(new OpenLayers.Geometry.Point(a[d].lon,
a[d].lat,a[d].alt));return b}function d(a,b,c){J.call(b,!0);a.style.openlayersStyle.title=a.style.openlayersStyle.graphicTitle=a.name;a.style.openlayersStyle.cursor=a.name||a.description?"pointer":"";a.visible?delete a.style.openlayersStyle.display:a.style.openlayersStyle.display="none";b=new OpenLayers.Feature.Vector(b,a,a.style.openlayersStyle);b.fid=a.id||a.name||b.fid;c.layer||fa(c);return b}if(a){r(a);OpenLayers.Feature.Vector.prototype.setVisible=function(a){a?this.hideAddedStyle?delete this.style:
delete this.style.display:this.style?this.style.display="none":(this.hideAddedStyle=!0,this.style=OpenLayers.Feature.Vector.style["delete"]);this.layer&&this.layer.drawFeature(this);for(a=this.data;a;){if(a.layer&&a.layer.strategies&&a.layer.strategies.length){a.layer.strategies[0].cluster(null,!0);break}a=a.parent}};OpenLayers.Feature.Vector.prototype.extendBounds=function(a){var b=this.geometry.getBounds();b&&(null!==b.left&&null!==b.top&&null!==b.right&&null!==b.bottom)&&a.extend(b)};OpenLayers.Feature.Vector.prototype.removeFromMap=
function(){this.layer&&this.layer.removeFeatures(this)};OpenLayers.Layer.Image.prototype.removeFromMap=function(){s.removeLayer(this);this.destroy()};OpenLayers.Layer.Image.prototype.extendBounds=function(a){null!==this.extent.left&&(null!==this.extent.top&&null!==this.extent.right&&null!==this.extent.bottom)&&a.extend(this.extent)};OpenLayers.Layer.Image.prototype.setVisible=function(a){this.setVisibility(a)};OpenLayers.Layer.Image.prototype.refreshIcon=function(a){this.remove();a.features=[e.groundOverlay(a)]};
var e={proxy:a.proxy,maxFileSize:a.constraints?a.constraints.maxFileSize:void 0,maxPlacemarks:a.constraints?a.constraints.maxPlacemarks:void 0,container:"#map",refreshInfoWindow:function(a){a.features.length&&(ea=a.features[0])},containerRemoved:function(a){a.layer&&(a.clustering||delete a.layer.strategies,ga(a.layer),delete a.layer)},parseCallback:function(a){jc2cui.mapWidget.totalMarkersLoaded(jc2cui.mapWidget.kmlParser.totalEntities());var b,c;c=a;for(var d,e,f=[];c.parent;)c=c.parent;b=c.overlayId;
c=c.featureId;if(d=jc2cui.mapWidget.kmlParser.getTreeData(a,a.visible,b,c))if($.isArray(d))for(e=0;e<d.length;e++)jc2cui.mapWidget.addTreeItems(d[e],b,c,a.parent?a.parent.internalId:void 0);else jc2cui.mapWidget.addTreeItems(d,b,c,a.parent?a.parent.internalId:void 0);a.layer&&(a.getAllPlacemarks(f),a.layer.addFeatures(f),l());ea&&(k(ea),ea=null)},region:function(a){a.latLonAltBox=new OpenLayers.Bounds(a.latLonAltBox.west,a.latLonAltBox.south,a.latLonAltBox.east,a.latLonAltBox.north);a.projectedLatLonBox=
a.latLonAltBox.clone();J.call(a.projectedLatLonBox,!0);a.latLonAltBox.projection=s.baseLayer.projection;return a},isRegionActive:function(a){a.latLonAltBox.projection.equals(s.baseLayer.projection)||(a.projectedLatLonBox=a.latLonAltBox.clone(),J.call(a.projectedLatLonBox,!0),a.latLonAltBox.projection=s.baseLayer.projection);var b,c,d;if(!s.getExtent().intersectsBounds(a.projectedLatLonBox))return!1;b=new OpenLayers.LonLat(a.projectedLatLonBox.bottom,a.projectedLatLonBox.left);c=new OpenLayers.LonLat(a.projectedLatLonBox.top,
a.projectedLatLonBox.right);b=s.getPixelFromLonLat(b);d=s.getPixelFromLonLat(c);c=Math.abs(d.x-b.x);b=Math.abs(d.y-b.y);b=Math.round(Math.sqrt(c*b)).toFixed(0);return b<a.lod.minLodPixels||0<=a.lod.maxLodPixels&&b>a.lod.maxLodPixels?!1:!0},formatView:function(a){var b=s.getExtent(),c=new OpenLayers.LonLat(b.bottom,b.left),d=new OpenLayers.LonLat(b.top,b.right),e=new OpenLayers.LonLat(b.top,b.left),b=b.getCenterLonLat(),f=s.getZoom(),f=352E5/Math.pow(2,f),g=$(s.viewPortDiv),h=1E3*OpenLayers.Util.distVincenty(c,
e),e=1E3*OpenLayers.Util.distVincenty(d,e);a=a.replace("[bboxWest]",c.lat);a=a.replace("[bboxSouth]",c.lon);a=a.replace("[bboxEast]",d.lat);a=a.replace("[bboxNorth]",d.lon);a=a.replace("[lookatLon]",b.lon);a=a.replace("[lookatLat]",b.lat);a=a.replace("[lookatRange]",f);a=a.replace("[lookatTilt]",0);a=a.replace("[lookatHeading]",0);a=a.replace("[horizFov]",e/2/f);a=a.replace("[vertFov]",h/2/f);a=a.replace("[horizPixels]",g.width());a=a.replace("[vertPixels]",g.height());return a=a.replace("[terrainEnabled]",
0)},marker:function(a,c,e){c=new OpenLayers.Geometry.Point(c.lon,c.lat,c.alt);a.style=a.style||{};a.style.IconStyle&&"0"===a.style.IconStyle.scale?a.style.openlayersStyle={}:(a.style.openLayersStyle||(a.style.openlayersStyle=b(a)),a.style.openlayersStyle.externalGraphic=a.style.openlayersStyle.externalGraphic||jc2cui.mapWidget.getDefaultIcon(),a.style.openlayersStyle.graphicOpacity=a.style.openlayersStyle.graphicOpacity||1,a.style.openlayersStyle.graphicWidth=a.style.openlayersStyle.graphicWidth||
32,a.style.openlayersStyle.graphicHeight=a.style.openlayersStyle.graphicHeight||32);return d(a,c,e)},polyline:function(a,e,f){e=new OpenLayers.Geometry.LineString(c(e));a.style=a.style||{};a.style.openLayersStyle||(a.style.openlayersStyle=b(a));a.style.openlayersStyle.strokeColor=a.style.openlayersStyle.strokeColor||"#ffffff";return d(a,e,f)},polygon:function(a,e,f){var g=[],h;for(h=0;h<e.length;h++)g.push(new OpenLayers.Geometry.LinearRing(c(e[h])));e=new OpenLayers.Geometry.Polygon(g);a.style=a.style||
{};a.style.openLayersStyle||(a.style.openlayersStyle=b(a));a.style.openlayersStyle.strokeColor=a.style.openlayersStyle.strokeColor||"#ffffff";a.style.openlayersStyle.fillColor=a.style.openlayersStyle.fillColor||"#ffffff";return d(a,e,f)},groundOverlay:function(a,b){var c=new OpenLayers.Bounds(a.latLonBox.west,a.latLonBox.south,a.latLonBox.east,a.latLonBox.north);J.call(c,!0);c=new OpenLayers.Layer.Image(a.name,a.icon.getHref(),c,new OpenLayers.Size(1,1),{opacity:a.opacity,isBaseLayer:!1,displayInLayerSwitcher:!1});
s.addLayer(c);return c},bounds:function(){return new OpenLayers.Bounds}};jc2cui.mapWidget.kmlParser.init(e)}else jc2cui.mapWidget.showError("Missing config file. Unable to configure open layers")},createOverlay:function(b,c,d){if(!z[b.overlayId]){var e;b.parentId&&((e=z[b.parentId])||console.log("open layers configured map widget unable to find parent overlay with id "+b.parentId));return new a(b.overlayId,b.name,e,b.clustering)}},removeOverlay:function(a,b,c){var d=z[a];d?d.remove():jc2cui.mapWidget.error({sender:b?
b.id:"",type:"map.overlay.remove",msg:c,error:"No overlay with id "+a+" found to remove."})},setOverlayVisibility:function(a,b,c,d){var e=z[a];e?e.setVisibility(b):jc2cui.mapWidget.error({sender:c?c.id:"",type:"map.overlay."+(b?"show":"hide"),msg:d,error:"No overlay with id "+a+" found to "+(b?"show.":"hide.")})},isOverlayVisible:function(a){a=(a=z[a])?a.visible:!1;return a},updateOverlay:function(a,b,c){b=z[a.overlayId];var d,e;if(!b)return!1;a.clustering&&(b.clustering=a.clustering,e=!0);a.parentId&&
((c=z[a.parentId])||console.log("maps V3 configured map widget unable to find parent overlay with id "+a.parentId),d=b.parent,d!==c&&(a=C(b),d&&delete d.children[b.id],b.parent=c,c.children[b.id]=b,b=C(b),a!==b&&(e=!0)));e&&(T(!1),T(!0));return!0},loadKml:function(a,b,c){K(a.overlayId,a.featureId,a.name||a.featureName||a.url,a.url,a.zoom,a.clustering,b,c)},loadWms:function(b,c,d){c=b.overlayId;d=b.featureId;var e=b.name||b.featureName||b.url,f=b.url,g=b.params,h=b.background,h=h||!1;b=z[c]||new a(c);
var k=b.docs[d],l=k?k.visible:b.visible,f={type:"WMS",params:[e,f]},m={isBaseLayer:h,displayInLayerSwitcher:h,visibility:l};k&&k.remove();g=g||[];f.params.push(g);f.params.push(m);g=p(f);g=new x(g,h);g.featureId=d;g.internalId=d;g.overlayId=c;g.name=e;b.docs[d]=g;g.setVisible(l,!0);jc2cui.mapWidget.addTreeItems({title:g.name||g.featureId,key:g.featureId,isFeature:!0,select:l},c)},parseKml:function(a,b,c){V(a.overlayId,a.featureId,a.name||a.featureName||"kml",a.feature,a.zoom,a.clustering,b,c)},removeFeature:function(a,
b,c){var d=z[a.overlayId],e=!1,f;if(d){y&&a.overlayId===jc2cui.mapWidget.USER_DRAWN_OVERLAY&&(f=y.getFeatureByFid(a.featureId))&&(y.destroyFeatures([f]),e=!0,jc2cui.mapWidget.infoWindow.getMapItem()&&jc2cui.mapWidget.infoWindow.getMapItem().id===a.featureId&&jc2cui.mapWidget.infoWindow.close());if(f=d.docs[a.featureId])f.remove(),delete d.docs[a.featureId],e=!0;e||jc2cui.mapWidget.error({sender:b?b.id:"",type:"map.feature.unplot",msg:c,error:"Unable to find feature "+a.featureId+" in overlay "+a.overlayId})}else jc2cui.mapWidget.error({sender:b?
b.id:"",type:"map.feature.unplot",msg:c,error:"Unable to find overlay "+a.overlayId})},updateFeature:function(a,b,c,d){c=z[a.overlayId];var e,f,g;a.clustering&&(e=!0);if(!c)return b.push("Unable to find overlay "+a.overlayId),!1;f=c.docs[a.featureId];if(!f)return b.push("Unable to find feature "+a.featureId+" in overlay "+a.overlayId),!1;if(a.newOverlayId&&a.newOverlayId!==a.overlayId){e||(g=C(f));d=z[a.newOverlayId];if(!d)return b.push("Unable to find overlay "+a.newOverlayId),!1;f.overlayId=a.newOverlayId;
d.docs[a.featureId]=f;delete c.docs[a.featureId];f.clustering=a.clustering;e||(a=C(f),g!==a&&(e=!0))}else e&&(f.clustering=a.clustering);e&&(T(!1),T(!0));return!0},showFeature:function(a,b,c){var d=z[a.overlayId],e=!1,f;if(d){y&&a.overlayId===jc2cui.mapWidget.USER_DRAWN_OVERLAY&&(f=y.getFeatureByFid(a.featureId))&&(f.style&&(f.hideAddedStyle?delete f.style:delete f.style.display,y.drawFeature(f)),e=!0);if(d=d.docs[a.featureId])d.setVisible(!0,!0),e=!0;e||jc2cui.mapWidget.error({sender:b?b.id:"",type:"map.feature.show",
msg:c,error:"Unable to find feature "+a.featureId+" in overlay "+a.overlayId})}else jc2cui.mapWidget.error({sender:b?b.id:"",type:"map.feature.show",msg:c,error:"Unable to find overlay "+a.overlayId})},hideFeature:function(a,b,c){var d=z[a.overlayId],e=!1,f=null;if(d){y&&a.overlayId===jc2cui.mapWidget.USER_DRAWN_OVERLAY&&(f=y.getFeatureByFid(a.featureId))&&(f.style?f.style.display="none":(f.hideAddedStyle=!0,f.style=OpenLayers.Feature.Vector.style["delete"]),y.redraw(),e=!0,jc2cui.mapWidget.infoWindow.getMapItem()&&
jc2cui.mapWidget.infoWindow.getMapItem().id===a.featureId&&jc2cui.mapWidget.infoWindow.close());if(d=d.docs[a.featureId])d.setVisible(!1,!0),e=!0;e||jc2cui.mapWidget.error({sender:b?b.id:"",type:"map.feature.hide",msg:c,error:"Unable to find feature "+a.featureId+" in overlay "+a.overlayId})}else jc2cui.mapWidget.error({sender:b?b.id:"",type:"map.feature.hide",msg:c,error:"Unable to find overlay "+a.overlayId})},showItem:function(a){var b=Y(a.itemId,a.overlayId);b&&(b.setVisible(!0,!0),a.zoom&&(a=
new OpenLayers.Bounds,b.extendBounds(a),h(a)))},hideItem:function(a){(a=Y(a.itemId,a.overlayId))&&a.setVisible(!1,!0)},centerOnOverlay:function(a,b,c){b=a.overlayId;a=a.zoom;(c=z[b])?(b=c.bounds(),h(b,a)):jc2cui.mapWidget.error({sender:"",type:"map.view.center.overlay",msg:void 0,error:"Unable to find overlay "+b})},centerOnFeature:function(a,b,c){var d=z[a.overlayId],e,f,g,k;d?(y&&a.overlayId===jc2cui.mapWidget.USER_DRAWN_OVERLAY&&(e=y.getFeatureByFid(a.featureId))&&(k=e.geometry.getBounds(),h(k,
a.zoom),a.select&&(f={selectedId:a.featureId||void 0,selectedName:e.attributes.title||e.attributes.name||void 0,featureId:a.featureId,overlayId:a.overlayId})),!e&&(g=d.docs[a.featureId])&&(D(g,a.zoom),a.select&&(f={selectedId:a.featureId||void 0,selectedName:g.features.length?g.features[0].name||void 0:void 0,featureId:a.featureId,overlayId:a.overlayId})),f&&jc2cui.mapWidget.itemSelected(f),e||g||jc2cui.mapWidget.error({sender:b?b.id:"",type:"map.center.feature",msg:c,error:"Unable to find feature "+
a.featureId+" in overlay "+a.overlayId})):jc2cui.mapWidget.error({sender:b?b.id:"",type:"map.center.feature",msg:c,error:"Unable to find overlay "+a.overlayId})},centerOnItem:function(a){var b=Y(a.itemId,a.overlayId);if(b&&(D(b,a.zoom),a.select)){for(a=b.parent;a.parent;)a=a.parent;b={selectedId:b.id||void 0,selectedName:b.name||void 0,featureId:a.featureId,overlayId:a.overlayId};jc2cui.mapWidget.itemSelected(b)}},centerOnLocation:function(a,b,c){b=new OpenLayers.LonLat(a.location.lon,a.location.lat);
J.call(b,!0);g(b,a.zoom)},fitToBounds:function(a){h(a,"auto")},centerOnBounds:function(a,b,c){b=new OpenLayers.LonLat(a.bounds.southWest.lon,a.bounds.southWest.lat);c=new OpenLayers.LonLat(a.bounds.northEast.lon,a.bounds.northEast.lat);var d=new OpenLayers.Bounds;d.extend(b);d.extend(c);J.call(d,!0);h(d,a.zoom)},zoomToRange:function(a,b,c){f(a.range)},selected:function(a,b,c){b=z[a.overlayId];var d;b?(y&&(a.selectedId&&a.overlayId===jc2cui.mapWidget.USER_DRAWN_OVERLAY)&&(d=y.getFeatureByFid(a.selectedId)),
d||(d=Y(a.selectedId,b.id,!0))&&(d=d.features[0]),d||(d=ha(a.selectedName,b.id))&&(d=d.features[0]),d?(a=d.geometry.getBounds().getCenterLonLat(),s.panTo(a)):console.log("open layers configured map widget unable to find selected item with id "+a.selectedId+" and name "+a.selectedName)):console.log("open layers configured map widget unable to find overlay "+a.overlayId+" for selected item with id "+a.selectedId+" and name "+a.selectedName)},getViewStatus:function(a,b,c){return q(a,b,c)},getDropLocation:function(){var a=
s.getLonLatFromPixel(O);J.call(a);return{lat:a.lat,lon:a.lon}},checkResize:function(){s.updateSize();setTimeout(function(){$.each(z,function(a,b){$.each(b.docs,function(a,b){var c=b.getAllScreenOverlays();$.each(c,function(a,b){b.placer()})})})},100);jc2cui.mapWidget.infoWindow.checkResize()},setDrawingToolsVisibility:function(a){m(a)},setExpanded:function(a,b,c){ja(a,b,c)},optionChanged:function(a,b){"labels"===a?S(b):"clustering"===a&&T(b)},info:function(){var a=0;$.each(z,function(b,c){++a});return{name:"Open Layers",
type:"2D",entities:jc2cui.mapWidget.kmlParser.getEntitiesString(a)}}}}();
